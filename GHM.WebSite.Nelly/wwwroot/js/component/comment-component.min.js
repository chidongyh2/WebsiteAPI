ko.components.register("comment-component",{viewModel:function(n){var t=this;t.objectId=n.objectId?ko.observable(n.objectId):ko.observable(-1);t.objectType=n.objectType?ko.observable(n.objectType):ko.observable(-1);t.isShowTitle=n.isShowTitle!==null?ko.observable(n.isShowTitle):ko.observable(!0);t.listComments=ko.observableArray([]);t.getComment=function(){$.get("/get-comment",{objectId:t.objectId(),objectType:t.objectType(),page:1,pageSize:20},function(n){t.listComments(n.items);console.log(n.items)})};$(document).ready(function(){t.getComment()})},template:`<div class="comments">
       <div class="line"></div>    
         <!--ko if: isShowTitle() -->
