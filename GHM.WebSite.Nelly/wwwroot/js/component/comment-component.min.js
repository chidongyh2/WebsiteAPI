ko.components.register("comment-component",{viewModel:function(n){var t=this;t.objectId=n.objectId?n.objectId:-1;t.objectType=n.objectType?n.objectType:-1;t.isShowTitle=n.isShowTitle!==null?ko.observable(n.isShowTitle):ko.observable(!0);t.listComments=ko.observableArray([]);t.rendTree=function(n){_.each(n,function(n){n.state.show=ko.observable(!1);n.children&&n.children.length>0&&t.rendTree(n.children)})};t.getComment=function(){$.get("/get-comment",{objectId:t.objectId,objectType:t.objectType,page:1,pageSize:20},function(n){t.rendTree(n.items);t.listComments(n.items);console.log(t.listComments())})};$(document).ready(function(){t.getComment()})},template:`<div class="comments">
       <div class="line"></div>
            <!--ko if: isShowTitle() -->
