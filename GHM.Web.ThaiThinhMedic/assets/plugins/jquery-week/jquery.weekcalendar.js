        ...
        return {
            ...
            _resizeCalendar: function () {
                ...
                if (options && $.isFunction(options.height)) {
                    ...
                    var headerHeight = this.element.find('.wc-header').height();
                    var navHeight = this.element.find('.wc-toolbar').height();
            ...
            _updateDayColumnHeader: function ($weekDayColumns) {
                ...
                if (this.options.title) {
                    var date = this.options.date,
                        ...
                        end = new Date(this._cloneDate(self.element.data('endDate')).getTime() - (MILLIS_IN_DAY)),
