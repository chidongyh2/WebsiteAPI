    ...
    var create_editor = function ($textarea, classes, placeholder, toolbar_position, toolbar_buttons, toolbar_submit, label_selectImage,
        ...
        var getUploadItem = function (item) {
            if (imageExtension.indexOf(item.Extension) > -1) {
                return "<span class='wrapper-image-content cursor' data-id='" + item.Id + "'><img src='" + item.Path + "?w=150&h=150&mode=pad' alt='" + item.Name + "' /></span>&nbsp;";
            } else {
        ...
        // HoangNH: onImageClick.
        var onImageClick = function () {
            $(".wrapper-image-content").on("click", function () {
