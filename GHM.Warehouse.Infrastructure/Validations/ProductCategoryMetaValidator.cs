...
namespace GHM.Warehouse.Infrastructure.Validations
{
    ...
    {
        public ProductCategoryMetaValidator(IResourceService<SharedResource> sharedResourceService, IResourceService<GhmWarehouseResource> productResourceService)
        {
    ...
    {
        public ProductCategoryTranslationMetaValidator(IResourceService<SharedResource> sharedResourceService, IResourceService<GhmWarehouseResource> surveyResourceService)
        {
            RuleFor(x => x.Name)
                .NotEmpty()
