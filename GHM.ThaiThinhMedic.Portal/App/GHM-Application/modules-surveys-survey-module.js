...
/* harmony import */ var _service_do_exam_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./service/do-exam.service */ "./src/app/modules/surveys/do-exam/service/do-exam.service.ts");
...
/* harmony import */ var _viewmodels_question_answer_viewmodel__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./viewmodels/question-answer-viewmodel */ "./src/app/modules/surveys/do-exam/viewmodels/question-answer-viewmodel.ts");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _question_models_question_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../question/models/question.model */ "./src/app/modules/surveys/question/models/question.model.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _question_viewmodels_answer_viewmodel__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../question/viewmodels/answer.viewmodel */ "./src/app/modules/surveys/question/viewmodels/answer.viewmodel.ts");
/* harmony import */ var _viewmodels_survey_user_answer_model__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./viewmodels/survey-user-answer.model */ "./src/app/modules/surveys/do-exam/viewmodels/survey-user-answer.model.ts");
...
var DoExamComponent = /** @class */ (function (_super) {
    __extends(DoExamComponent, _super);
    function DoExamComponent(route, cdr, toastr, router, spinnerService, doExamService) {
        ...
        _this.questionType = _question_models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionType"];
        _this.totalQuestion = 0;
        _this.totalQuestionHasAnswer = 0;
        _this.totalQuestionNotAnswer = 0;
        _this.listQuestionIndexHasAnswer = [];
        _this.errorMessage = '';
        _this.questionAnswerStatus = _question_models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionAnswerStatus"];
    ...
    DoExamComponent.prototype.ngOnInit = function () {
            ...
            if (params.id) {
                _this.doExamService.start(params.id)
                    ...
                    if (_this.surveyUserInfo) {
                        ...
                        if (_this.surveyUserInfo.totalSeconds <= 0) {
                            _this.isFinish = true;
                            _this.finishExam();
                        }
        ...
        this.noTab = _question_models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionAnswerStatus"].all;
    };
    ...
    DoExamComponent.prototype.startCountdownTimer = function () {
        ...
        var stream$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_9__["timer"])(0, interval1);
    ...
    DoExamComponent.prototype.userAnswer = function (question, answer, index) {
        ...
        var surveyUserAnswer = new _viewmodels_survey_user_answer_model__WEBPACK_IMPORTED_MODULE_8__["SurveyUserAnswerModel"]();
        ...
        if (question.questionType === _question_models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionType"].essay || question.questionType === _question_models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionType"].selfResponded) {
            if (!answer.value) {
        ...
        this.doExamService.answer(surveyUserAnswer).subscribe(function (result) {
            ...
            if (question.questionType === _question_models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionType"].multiChoice) {
                var totalSelected = lodash__WEBPACK_IMPORTED_MODULE_4__["countBy"](question.answers, function (answerItem) {
                    return answerItem.isSelected;
                }).true;
                if (!totalSelected) {
                    lodash__WEBPACK_IMPORTED_MODULE_4__["remove"](_this.listQuestionIndexHasAnswer, function (item) {
            ...
            if (question.questionType === _question_models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionType"].vote) {
    ...
    DoExamComponent.prototype.getTotalAnswer = function () {
        var listQuestionHasAnswer = lodash__WEBPACK_IMPORTED_MODULE_4__["filter"](this.listAllQuestion, function (item) {
    ...
    DoExamComponent.prototype.showQuestionNoAnswer = function () {
        this.noTab = _question_models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionAnswerStatus"].noAnswer;
        this.listQuestion = lodash__WEBPACK_IMPORTED_MODULE_4__["filter"](this.listAllQuestion, function (item) {
            return !item.isAnswer;
        });
    };
    DoExamComponent.prototype.showQuestionHasAnswer = function () {
        this.noTab = _question_models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionAnswerStatus"].hasAnswer;
        this.listQuestion = lodash__WEBPACK_IMPORTED_MODULE_4__["filter"](this.listAllQuestion, function (item) {
            return item.isAnswer;
        });
    };
    DoExamComponent.prototype.renderResult = function (listQuestionAnswer) {
        ...
        if (listQuestionAnswer && listQuestionAnswer.length > 0) {
            var groupByQuestionVersionIds = lodash__WEBPACK_IMPORTED_MODULE_4__["groupBy"](listQuestionAnswer, function (item) {
                return item.questionVersionId;
            });
            this.listQuestion = [];
            this.listQuestionIndexHasAnswer = [];
            var index_1 = 0;
            lodash__WEBPACK_IMPORTED_MODULE_4__["each"](groupByQuestionVersionIds, function (items) {
                var key = items[0];
                var question = new _viewmodels_question_answer_viewmodel__WEBPACK_IMPORTED_MODULE_3__["QuestionAnswerViewModel"]();
                ...
                var listAnswer = [];
                var isAnswer = false;
                if (key.questionType === _question_models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionType"].essay) {
                    var answer = new _question_viewmodels_answer_viewmodel__WEBPACK_IMPORTED_MODULE_7__["AnswerViewModel"]();
                ...
                if (key.questionType === _question_models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionType"].singleChoice || key.questionType === _question_models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionType"].multiChoice
                    || key.questionType === _question_models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionType"].vote
                    || (key.questionType === _question_models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionType"].selfResponded)) {
                    lodash__WEBPACK_IMPORTED_MODULE_4__["each"](items, function (item) {
                        var answer = new _question_viewmodels_answer_viewmodel__WEBPACK_IMPORTED_MODULE_7__["AnswerViewModel"]();
                        ...
                        answer.orderSelect = key.questionType === _question_models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionType"].vote && item.surveyUserAnswerId ? item.answerOrder : 0;
                        answer.order = item.answerOrder;
                        answer.isSelected = item.isSelected
                            || (key.questionType === _question_models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionType"].selfResponded && item.surveyUserAnswerId != null);
                        answer.surveyUserAnswerId = item.surveyUserAnswerId;
                        isAnswer = answer.isSelected || isAnswer;
                        listAnswer.push(answer);
                    });
                    if (key.questionType === _question_models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionType"].selfResponded && key.totalAnswer) {
                        var listHasAnswer = lodash__WEBPACK_IMPORTED_MODULE_4__["filter"](listAnswer, function (answer) {
                ...
                if (key.questionType === _question_models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionType"].vote) {
                    var answerSelect = lodash__WEBPACK_IMPORTED_MODULE_4__["first"](lodash__WEBPACK_IMPORTED_MODULE_4__["filter"](listAnswer, function (item) {
                ...
                question.answers = lodash__WEBPACK_IMPORTED_MODULE_4__["orderBy"](listAnswer, function (item) {
                    return item.order;
                });
    ...
    DoExamComponent.prototype.getColAndRowTableScore = function () {
        ...
        this.listColTableScore = lodash__WEBPACK_IMPORTED_MODULE_4__["range"](1, this.colTableScore + 1);
        this.listRowTableScore = lodash__WEBPACK_IMPORTED_MODULE_4__["range"](1, this.rowTableScore + 1);
    };
    __decorate([
    ...
    DoExamComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [_service_do_exam_service__WEBPACK_IMPORTED_MODULE_1__["DoExamService"]]
        }),
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_6__["ActivatedRoute"],
            ...
            _service_do_exam_service__WEBPACK_IMPORTED_MODULE_1__["DoExamService"]])
    ], DoExamComponent);
...
var DoExamResolve = /** @class */ (function () {
    ...
    DoExamResolve = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [_service_do_exam_service__WEBPACK_IMPORTED_MODULE_1__["DoExamService"]])
    ], DoExamResolve);
...
var ExamDetailComponent = /** @class */ (function (_super) {
    __extends(ExamDetailComponent, _super);
    function ExamDetailComponent(route, router, cdr, toastr, spinnerService, doExamService) {
        var _this = _super.call(this) || this;
        _this.route = route;
        _this.router = router;
        _this.cdr = cdr;
        ...
        _this.spinnerService = spinnerService;
        _this.doExamService = doExamService;
        _this.questionType = _question_models_question_model__WEBPACK_IMPORTED_MODULE_6__["QuestionType"];
        _this.totalQuestion = 0;
        _this.totalQuestionHasAnswer = 0;
        _this.totalQuestionNotAnswer = 0;
        _this.listQuestionIndexHasAnswer = [];
    ...
    ExamDetailComponent.prototype.getTotalAnswer = function () {
        var totalQuestionAnswer = lodash__WEBPACK_IMPORTED_MODULE_1__["countBy"](this.listAllQuestion, function (item) {
            return item.isAnswer;
        }).true;
    ...
    ExamDetailComponent.prototype.showQuestionNoAnswer = function () {
        ...
        this.listQuestion = lodash__WEBPACK_IMPORTED_MODULE_1__["filter"](this.listAllQuestion, function (item) {
            return !item.isAnswer;
        });
    };
    ...
    ExamDetailComponent.prototype.renderResult = function (listQuestionAnswer) {
        var _this = this;
        if (listQuestionAnswer && listQuestionAnswer.length > 0) {
            var groupByQuestionVersionIds = lodash__WEBPACK_IMPORTED_MODULE_1__["groupBy"](listQuestionAnswer, function (item) {
                return item.questionVersionId;
            });
            this.listQuestion = [];
            this.listQuestionIndexHasAnswer = [];
            ...
            var index_1 = 0;
            lodash__WEBPACK_IMPORTED_MODULE_1__["each"](groupByQuestionVersionIds, function (items) {
                var key = items[0];
                ...
                var isAnswer = false;
                var isCorrect;
                if (key.questionType === _question_models_question_model__WEBPACK_IMPORTED_MODULE_6__["QuestionType"].essay) {
                ...
                if (key.questionType === _question_models_question_model__WEBPACK_IMPORTED_MODULE_6__["QuestionType"].singleChoice || key.questionType === _question_models_question_model__WEBPACK_IMPORTED_MODULE_6__["QuestionType"].multiChoice
                    || key.questionType === _question_models_question_model__WEBPACK_IMPORTED_MODULE_6__["QuestionType"].vote
                    || (key.questionType === _question_models_question_model__WEBPACK_IMPORTED_MODULE_6__["QuestionType"].selfResponded)) {
                    lodash__WEBPACK_IMPORTED_MODULE_1__["each"](items, function (item) {
                        var answer = new _question_viewmodels_answer_viewmodel__WEBPACK_IMPORTED_MODULE_9__["AnswerViewModel"]();
                        answer.answerId = item.answerId;
                        answer.questionVersionId = key.questionVersionId;
                        answer.name = item.answerName;
                        answer.value = item.answerValue;
                        answer.orderSelect = key.questionType === _question_models_question_model__WEBPACK_IMPORTED_MODULE_6__["QuestionType"].vote && item.surveyUserAnswerId ? item.answerOrder : 0;
                        answer.order = item.answerOrder;
                        answer.isSelected = item.isSelected
                            || (key.questionType === _question_models_question_model__WEBPACK_IMPORTED_MODULE_6__["QuestionType"].selfResponded && item.surveyUserAnswerId != null);
                        answer.surveyUserAnswerId = item.surveyUserAnswerId;
                        answer.isCorrect = item.isCorrect;
                        answer.answerIsCorrect = item.answerIsCorrect;
                        isAnswer = answer.isSelected || isAnswer;
                        isCorrect = key.questionType === _question_models_question_model__WEBPACK_IMPORTED_MODULE_6__["QuestionType"].singleChoice ? isCorrect || item.isCorrect :
                            key.questionType === _question_models_question_model__WEBPACK_IMPORTED_MODULE_6__["QuestionType"].multiChoice ? !(answer.isSelected && !answer.isCorrect) : isCorrect;
                        listAnswer.push(answer);
                    });
                    if (key.questionType === _question_models_question_model__WEBPACK_IMPORTED_MODULE_6__["QuestionType"].selfResponded && key.totalAnswer) {
                        var listHasAnswer = lodash__WEBPACK_IMPORTED_MODULE_1__["filter"](listAnswer, function (answer) {
                            return answer.surveyUserAnswerId;
                        });
                        var totalAnswerSelfResponded = !listHasAnswer || listHasAnswer.length === 0 ? key.totalAnswer
                            : key.totalAnswer - listHasAnswer.length;
                ...
                if (key.questionType === _question_models_question_model__WEBPACK_IMPORTED_MODULE_6__["QuestionType"].multiChoice) {
                    isCorrect = (lodash__WEBPACK_IMPORTED_MODULE_1__["countBy"](listAnswer, function (item) {
                        return item.isCorrect;
                    }).true === lodash__WEBPACK_IMPORTED_MODULE_1__["countBy"](listAnswer, function (item) {
                        return item.answerIsCorrect;
                    }).true) && isCorrect;
                }
                if (key.questionType === _question_models_question_model__WEBPACK_IMPORTED_MODULE_6__["QuestionType"].vote) {
                    var answerSelect = lodash__WEBPACK_IMPORTED_MODULE_1__["first"](lodash__WEBPACK_IMPORTED_MODULE_1__["filter"](listAnswer, function (item) {
                        return item.surveyUserAnswerId;
                    }));
                    question.orderAnswerSelect = answerSelect ? answerSelect.orderSelect : 0;
                }
                ...
                question.answers = lodash__WEBPACK_IMPORTED_MODULE_1__["orderBy"](listAnswer, function (item) {
                    return item.order;
                });
                _this.listQuestion.push(question);
                _this.totalQuestion = index_1;
    ...
    ExamDetailComponent.prototype.getColAndRowTableScore = function () {
        ...
        this.listColTableScore = lodash__WEBPACK_IMPORTED_MODULE_1__["range"](1, this.colTableScore + 1);
        this.listRowTableScore = lodash__WEBPACK_IMPORTED_MODULE_1__["range"](1, this.rowTableScore + 1);
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["HostListener"])('window:resize', ['$event']),
        __metadata("design:type", Function),
...
module.exports = "<div class=\"container survey-over-view\">\r\n    <div class=\"row\" *ngIf=\"errorMessage\">\r\n        <div class=\"col-sm-12 cm-mgt-10\">\r\n            <div class=\"alert alert-danger\">\r\n                {{ errorMessage }}\r\n            </div>\r\n        </div>\r\n    </div>\r\n    <div class=\"row\">\r\n        <div class=\"col-sm-12\">\r\n            <div class=\"regulate-survey\">\r\n                <h4 class=\"star-title fontSize18\" i18n=\"@@regulatedSurvey\">Regulated survey</h4>\r\n                <hr>\r\n                <div class=\"content\">\r\n                    <span [innerHtml]=\"examOverviewInfo?.surveyDescription\"></span>\r\n                </div>\r\n            </div>\r\n            <div class=\"survey-information\">\r\n                <h3 class=\"survey-name\" i18n=\"@@surveyInfo\">Survey Information</h3>\r\n                <div class=\"survey-item-info\">\r\n                    <div class=\"survey-item-label\">\r\n                        <span i18n=\"@@surveyName\" class=\"item-label\">Survey name: </span>{{examOverviewInfo.surveyName}}\r\n                    </div>\r\n                </div>\r\n                <div class=\"survey-item-info\">\r\n                    <div class=\"survey-item-label\">\r\n                        <span i18n=\"@@totalQuestion\" class=\"item-label\">Total question: </span>{{examOverviewInfo.totalQuestion}}\r\n                    </div>\r\n                </div>\r\n                <div class=\"survey-item-info\">\r\n                    <div class=\"survey-item-label\">\r\n                        <span i18n=\"@@startTime\" class=\"item-label\">Start time: </span>{{examOverviewInfo.startDate |\r\n                        dateTimeFormat:'DD/MM/YYYY'}}\r\n                    </div>\r\n                </div>\r\n                <div class=\"survey-item-info\">\r\n                    <div class=\"survey-item-label\">\r\n                        <span i18n=\"@@endTime\" class=\"item-label\">End time: </span>{{examOverviewInfo.endDate |\r\n                        dateTimeFormat:'DD/MM/YYYY'}}\r\n                    </div>\r\n                </div>\r\n                <div class=\"survey-item-info\">\r\n                    <div class=\"survey-item-label\">\r\n                        <span i18n=\"@@totalTime\" class=\"item-label\">Total time: </span>{{transform(examOverviewInfo?.limitedTime\r\n                        * 60)}}\r\n                    </div>\r\n                </div>\r\n                <div class=\"survey-item-info\">\r\n                    <div class=\"survey-item-label\">\r\n                        <span i18n=\"examIsRequired\" class=\"item-label\">Bài thì bắt buộc:  </span>\r\n                        <mat-checkbox disabled=\"true\" [(ngModel)]=\"examOverviewInfo.isRequired\"></mat-checkbox>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n        </div>\r\n        <div class=\"col-sm-12 cm-mgb-20 cm-mgt-20 center\" *ngIf=\"!errorMessage\">\r\n            <a routerLink=\"/surveys/start/{{examOverviewInfo.surveyId}}\" class=\"btn btn-primary\"\r\n               i18n=\"@@startExam\">\r\n                Start Exam\r\n            </a>\r\n        </div>\r\n    </div>\r\n</div>\r\n"
...
/* harmony import */ var _viewmodels_exam_overview_viewmodel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../viewmodels/exam-overview.viewmodel */ "./src/app/modules/surveys/do-exam/viewmodels/exam-overview.viewmodel.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _service_do_exam_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../service/do-exam.service */ "./src/app/modules/surveys/do-exam/service/do-exam.service.ts");
...
var ExamOverviewComponent = /** @class */ (function (_super) {
    __extends(ExamOverviewComponent, _super);
    function ExamOverviewComponent(route, router, spinnerService, doExamService) {
        ...
        _this.doExamService = doExamService;
        _this.errorMessage = '';
        _this.examOverviewInfo = new _viewmodels_exam_overview_viewmodel__WEBPACK_IMPORTED_MODULE_2__["ExamOverviewViewModel"]();
        return _this;
    }
    ...
    ExamOverviewComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            styles: [__webpack_require__(/*! ../../survey.component.scss */ "./src/app/modules/surveys/survey.component.scss")],
            providers: [_service_do_exam_service__WEBPACK_IMPORTED_MODULE_4__["DoExamService"]]
        }),
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"],
            _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"],
            _core_spinner_spinner_service__WEBPACK_IMPORTED_MODULE_6__["SpinnerService"],
            _service_do_exam_service__WEBPACK_IMPORTED_MODULE_4__["DoExamService"]])
...
var ExamOverviewResolve = /** @class */ (function () {
    ...
    ExamOverviewResolve = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _survey_report_survey_report_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../survey-report/survey-report.service */ "./src/app/modules/surveys/survey-report/survey-report.service.ts");
/* harmony import */ var _base_list_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../base-list.component */ "./src/app/base-list.component.ts");
...
/* harmony import */ var _survey_group_services_survey_group_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../survey-group/services/survey-group.service */ "./src/app/modules/surveys/survey-group/services/survey-group.service.ts");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var _survey_report_survey_report_user_answer_times_survey_report_user_answer_times_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../survey-report/survey-report-user-answer-times/survey-report-user-answer-times.component */ "./src/app/modules/surveys/survey-report/survey-report-user-answer-times/survey-report-user-answer-times.component.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
...
var MySurveyComponent = /** @class */ (function (_super) {
    __extends(MySurveyComponent, _super);
    ...
    MySurveyComponent.prototype.ngOnInit = function () {
        ...
        this.listItems$ = this.surveyReportService.getSurveyByUserId(this.keyword, this.surveyGroupId, this.startDate, this.endDate, this.currentPage, this.pageSize).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(function () { return _this.isSearching = false; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (result) {
    ...
    MySurveyComponent.prototype.showDetail = function (surveyId, surveyUserId) {
    ...
    MySurveyComponent.prototype.renderFilterLink = function () {
        ...
        var query = this.utilService.renderLocationFilter([
            ...
            new _shareds_models_filter_link_model__WEBPACK_IMPORTED_MODULE_9__["FilterLink"]('surveyGroupId', this.surveyGroupId),
            new _shareds_models_filter_link_model__WEBPACK_IMPORTED_MODULE_9__["FilterLink"]('startDate', this.startDate),
            new _shareds_models_filter_link_model__WEBPACK_IMPORTED_MODULE_9__["FilterLink"]('endDate', this.endDate),
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_survey_report_survey_report_user_answer_times_survey_report_user_answer_times_component__WEBPACK_IMPORTED_MODULE_6__["SurveyReportUserAnswerTimesComponent"]),
        __metadata("design:type", _survey_report_survey_report_user_answer_times_survey_report_user_answer_times_component__WEBPACK_IMPORTED_MODULE_6__["SurveyReportUserAnswerTimesComponent"])
    ], MySurveyComponent.prototype, "surveyReportUserAnswerTimesComponent", void 0);
    MySurveyComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [
                _angular_common__WEBPACK_IMPORTED_MODULE_11__["Location"], { provide: _angular_common__WEBPACK_IMPORTED_MODULE_11__["LocationStrategy"], useClass: _angular_common__WEBPACK_IMPORTED_MODULE_11__["PathLocationStrategy"] },
                _survey_group_services_survey_group_service__WEBPACK_IMPORTED_MODULE_4__["SurveyGroupService"], _survey_report_survey_report_service__WEBPACK_IMPORTED_MODULE_1__["SurveyReportService"]
            ]
        }),
        ...
        __metadata("design:paramtypes", [Object, Object, _angular_common__WEBPACK_IMPORTED_MODULE_11__["Location"],
            _angular_router__WEBPACK_IMPORTED_MODULE_7__["ActivatedRoute"],
            _angular_router__WEBPACK_IMPORTED_MODULE_7__["Router"],
            _shareds_services_util_service__WEBPACK_IMPORTED_MODULE_10__["UtilService"],
            _survey_group_services_survey_group_service__WEBPACK_IMPORTED_MODULE_4__["SurveyGroupService"],
            _survey_report_survey_report_service__WEBPACK_IMPORTED_MODULE_1__["SurveyReportService"]])
    ], MySurveyComponent);
...
/* harmony import */ var _core_spinner_spinner_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../../core/spinner/spinner.service */ "./src/app/core/spinner/spinner.service.ts");
/* harmony import */ var _service_question_group_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../service/question-group.service */ "./src/app/modules/surveys/question-group/service/question-group.service.ts");
...
var QuestionGroupFormComponent = /** @class */ (function (_super) {
    __extends(QuestionGroupFormComponent, _super);
    function QuestionGroupFormComponent(pageId, fb, toastr, spinnerService, questionGroupService, utilService) {
        var _this = _super.call(this) || this;
        _this.fb = fb;
        _this.toastr = toastr;
        _this.spinnerService = spinnerService;
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('questionGroupFormModal'),
    ...
    QuestionGroupFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        __metadata("design:paramtypes", [Object, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"],
            ngx_toastr__WEBPACK_IMPORTED_MODULE_2__["ToastrService"],
            _core_spinner_spinner_service__WEBPACK_IMPORTED_MODULE_10__["SpinnerService"],
            _service_question_group_service__WEBPACK_IMPORTED_MODULE_11__["QuestionGroupService"],
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _service_question_group_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./service/question-group.service */ "./src/app/modules/surveys/question-group/service/question-group.service.ts");
...
var QuestionGroupComponent = /** @class */ (function (_super) {
    __extends(QuestionGroupComponent, _super);
    function QuestionGroupComponent(pageId, appConfig, location, route, router, toastr, cdr, questionGroupService, helperService, utilService) {
        var _this = _super.call(this) || this;
        _this.pageId = pageId;
        _this.appConfig = appConfig;
        _this.location = location;
    ...
    QuestionGroupComponent.prototype.search = function (currentPage) {
        ...
        this.listItems$ = this.questionGroupService.search(this.keyword, this.isActive, this.currentPage, this.pageSize)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(function () { return _this.isSearching = false; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (data) {
            _this.totalRows = data.totalRows;
            return data.items;
        }));
    };
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_question_group_form_question_group_form_component__WEBPACK_IMPORTED_MODULE_12__["QuestionGroupFormComponent"]),
        __metadata("design:type", _question_group_form_question_group_form_component__WEBPACK_IMPORTED_MODULE_12__["QuestionGroupFormComponent"])
    ...
    QuestionGroupComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [
                ...
                _shareds_services_helper_service__WEBPACK_IMPORTED_MODULE_3__["HelperService"], _service_question_group_service__WEBPACK_IMPORTED_MODULE_1__["QuestionGroupService"]
            ]
        }),
        ...
        __param(1, Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Inject"])(_configs_app_config__WEBPACK_IMPORTED_MODULE_8__["APP_CONFIG"])),
        __metadata("design:paramtypes", [Object, Object, _angular_common__WEBPACK_IMPORTED_MODULE_2__["Location"],
            _angular_router__WEBPACK_IMPORTED_MODULE_10__["ActivatedRoute"],
            _angular_router__WEBPACK_IMPORTED_MODULE_10__["Router"],
            ngx_toastr__WEBPACK_IMPORTED_MODULE_9__["ToastrService"],
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"],
            _service_question_group_service__WEBPACK_IMPORTED_MODULE_1__["QuestionGroupService"],
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _service_question_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../service/question.service */ "./src/app/modules/surveys/question/service/question.service.ts");
/* harmony import */ var _models_answer_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/answer.model */ "./src/app/modules/surveys/question/models/answer.model.ts");
/* harmony import */ var _models_question_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../models/question.model */ "./src/app/modules/surveys/question/models/question.model.ts");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_4__);
...
var AnswerComponent = /** @class */ (function () {
    function AnswerComponent(toastr, questionService) {
        this.toastr = toastr;
        this.questionService = questionService;
        this.listAnswer = [];
        this.onSelectAnswer = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        this.questionType = _models_question_model__WEBPACK_IMPORTED_MODULE_3__["QuestionType"];
    }
    ...
    AnswerComponent.prototype.removeAnswer = function (answer, i) {
        if ((this.type === _models_question_model__WEBPACK_IMPORTED_MODULE_3__["QuestionType"].singleChoice || this.type === _models_question_model__WEBPACK_IMPORTED_MODULE_3__["QuestionType"].multiChoice)
    ...
    AnswerComponent.prototype.addNewAnswer = function () {
        var answer = new _models_answer_model__WEBPACK_IMPORTED_MODULE_2__["Answer"]();
    ...
    AnswerComponent.prototype.changeIsCorrectStatus = function (answer) {
        if (this.type === _models_question_model__WEBPACK_IMPORTED_MODULE_3__["QuestionType"].singleChoice) {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], AnswerComponent.prototype, "score", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", Object)
    ...
    AnswerComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [_service_question_service__WEBPACK_IMPORTED_MODULE_1__["QuestionService"]]
        }),
        __metadata("design:paramtypes", [ngx_toastr__WEBPACK_IMPORTED_MODULE_6__["ToastrService"],
            _service_question_service__WEBPACK_IMPORTED_MODULE_1__["QuestionService"]])
    ], AnswerComponent);
...
/*!*******************************************************************!*\
  !*** ./src/app/modules/surveys/question/models/question.model.ts ***!
  \*******************************************************************/
/*! exports provided: QuestionType, QuestionStatus, QuestionAnswerStatus, Question */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _service_question_approve_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../service/question-approve.service */ "./src/app/modules/surveys/question/service/question-approve.service.ts");
/* harmony import */ var _base_list_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../base-list.component */ "./src/app/base-list.component.ts");
/* harmony import */ var _models_question_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../models/question.model */ "./src/app/modules/surveys/question/models/question.model.ts");
/* harmony import */ var ngx_toastr__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ngx-toastr */ "./node_modules/ngx-toastr/fesm5/ngx-toastr.js");
...
/* harmony import */ var _question_group_service_question_group_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../question-group/service/question-group.service */ "./src/app/modules/surveys/question-group/service/question-group.service.ts");
...
/* harmony import */ var _question_detail_question_detail_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../question-detail/question-detail.component */ "./src/app/modules/surveys/question/question-detail/question-detail.component.ts");
/* harmony import */ var _question_explain_decline_reason_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./question-explain-decline-reason.component */ "./src/app/modules/surveys/question/question-approve/question-explain-decline-reason.component.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var QuestionApproveComponent = /** @class */ (function (_super) {
    __extends(QuestionApproveComponent, _super);
    function QuestionApproveComponent(pageId, appConfig, location, route, router, toastr, cdr, questionApproveService, helperService, questionGroupService, utilService) {
        ...
        _this.questionGroupService = questionGroupService;
        _this.utilService = utilService;
        _this.questionType = _models_question_model__WEBPACK_IMPORTED_MODULE_3__["QuestionType"]; // Loại câu hỏi
        _this.questionStatus = _models_question_model__WEBPACK_IMPORTED_MODULE_3__["QuestionStatus"]; // Trạng thái phê duyệt
        _this.isSelectAll = false;
        _this.isSelectQuestion = false;
        _this.listQuestionType = [
            { id: _models_question_model__WEBPACK_IMPORTED_MODULE_3__["QuestionType"].singleChoice, name: 'SingleChoice' },
            { id: _models_question_model__WEBPACK_IMPORTED_MODULE_3__["QuestionType"].multiChoice, name: 'MultiChoice' },
            { id: _models_question_model__WEBPACK_IMPORTED_MODULE_3__["QuestionType"].essay, name: 'Essay' },
            { id: _models_question_model__WEBPACK_IMPORTED_MODULE_3__["QuestionType"].vote, name: 'Vote' },
            {
                id: _models_question_model__WEBPACK_IMPORTED_MODULE_3__["QuestionType"].selfResponded, name: 'Self Responded'
            }
        ];
        _this.listQuestionStatus = [
            { id: _models_question_model__WEBPACK_IMPORTED_MODULE_3__["QuestionStatus"].pending, name: 'Pending' },
            { id: _models_question_model__WEBPACK_IMPORTED_MODULE_3__["QuestionStatus"].approved, name: 'Approved' },
            { id: _models_question_model__WEBPACK_IMPORTED_MODULE_3__["QuestionStatus"].decline, name: 'Decline' }
        ];
        return _this;
    }
    ...
    QuestionApproveComponent.prototype.updateMultiStatus = function (status) {
        ...
        var listQuestionVersionIdDraftSelect = lodash__WEBPACK_IMPORTED_MODULE_14__["map"](lodash__WEBPACK_IMPORTED_MODULE_14__["filter"](this.listQuestion, function (item) {
            return item.isCheck && item.questionStatus === _models_question_model__WEBPACK_IMPORTED_MODULE_3__["QuestionStatus"].pending;
        ...
        if (status === _models_question_model__WEBPACK_IMPORTED_MODULE_3__["QuestionStatus"].decline) {
        ...
        this.questionApproveService.updateMultiStatus(listQuestionUpdateStatus).subscribe(function (result) {
            var listResult = lodash__WEBPACK_IMPORTED_MODULE_14__["filter"](result, function (item) {
                return item.code > 0;
            });
    ...
    QuestionApproveComponent.prototype.updateStatus = function (question, status) {
        ...
        this.questionApproveService.updateStatus(question.versionId, status).subscribe(function () {
            ...
            question.statusName = status === _models_question_model__WEBPACK_IMPORTED_MODULE_3__["QuestionStatus"].approved ? 'Approved' : status === _models_question_model__WEBPACK_IMPORTED_MODULE_3__["QuestionStatus"].decline ? 'Decline' : '';
        });
    };
    ...
    QuestionApproveComponent.prototype.renderFilterLink = function () {
        var path = 'surveys/question-approve';
        var query = this.utilService.renderLocationFilter([
            new _shareds_models_filter_link_model__WEBPACK_IMPORTED_MODULE_12__["FilterLink"]('keyword', this.keyword),
            new _shareds_models_filter_link_model__WEBPACK_IMPORTED_MODULE_12__["FilterLink"]('questionType', this.type),
            new _shareds_models_filter_link_model__WEBPACK_IMPORTED_MODULE_12__["FilterLink"]('questionGroupId', this.questionGroupId),
            new _shareds_models_filter_link_model__WEBPACK_IMPORTED_MODULE_12__["FilterLink"]('creatorId', this.userIdSearch),
            new _shareds_models_filter_link_model__WEBPACK_IMPORTED_MODULE_12__["FilterLink"]('questionStatus', this.status),
    ...
    QuestionApproveComponent.prototype.getQuestionVersionIdSelect = function () {
        ...
        this.isShowApprove = this.checkQuestionByStatus(_models_question_model__WEBPACK_IMPORTED_MODULE_3__["QuestionStatus"].approved);
        this.isShowDecline = this.checkQuestionByStatus(_models_question_model__WEBPACK_IMPORTED_MODULE_3__["QuestionStatus"].decline);
    ...
    QuestionApproveComponent.prototype.checkQuestionByStatus = function (status) {
        var listQuestionByStatus = lodash__WEBPACK_IMPORTED_MODULE_14__["filter"](this.listQuestion, function (item) {
            return item.isCheck && item.questionStatus === _models_question_model__WEBPACK_IMPORTED_MODULE_3__["QuestionStatus"].pending;
        });
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_question_detail_question_detail_component__WEBPACK_IMPORTED_MODULE_15__["QuestionDetailComponent"]),
        __metadata("design:type", _question_detail_question_detail_component__WEBPACK_IMPORTED_MODULE_15__["QuestionDetailComponent"])
    ], QuestionApproveComponent.prototype, "questionDetailComponent", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_question_explain_decline_reason_component__WEBPACK_IMPORTED_MODULE_16__["QuestionExplainDeclineReasonComponent"]),
        __metadata("design:type", _question_explain_decline_reason_component__WEBPACK_IMPORTED_MODULE_16__["QuestionExplainDeclineReasonComponent"])
    ...
    QuestionApproveComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [_angular_common__WEBPACK_IMPORTED_MODULE_7__["Location"], { provide: _angular_common__WEBPACK_IMPORTED_MODULE_7__["LocationStrategy"], useClass: _angular_common__WEBPACK_IMPORTED_MODULE_7__["PathLocationStrategy"] },
                _service_question_approve_service__WEBPACK_IMPORTED_MODULE_1__["QuestionApproveService"], _shareds_services_helper_service__WEBPACK_IMPORTED_MODULE_5__["HelperService"], _question_group_service_question_group_service__WEBPACK_IMPORTED_MODULE_11__["QuestionGroupService"]]
        }),
        ...
        __metadata("design:paramtypes", [Object, Object, _angular_common__WEBPACK_IMPORTED_MODULE_7__["Location"],
            _angular_router__WEBPACK_IMPORTED_MODULE_9__["ActivatedRoute"],
            _angular_router__WEBPACK_IMPORTED_MODULE_9__["Router"],
            ngx_toastr__WEBPACK_IMPORTED_MODULE_4__["ToastrService"],
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"],
            _service_question_approve_service__WEBPACK_IMPORTED_MODULE_1__["QuestionApproveService"],
            _shareds_services_helper_service__WEBPACK_IMPORTED_MODULE_5__["HelperService"],
            _question_group_service_question_group_service__WEBPACK_IMPORTED_MODULE_11__["QuestionGroupService"],
...
/* harmony import */ var _service_question_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../service/question.service */ "./src/app/modules/surveys/question/service/question.service.ts");
/* harmony import */ var rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! rxjs/internal/operators */ "./node_modules/rxjs/internal/operators/index.js");
/* harmony import */ var rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_5__);
...
var QuestionExplainDeclineReasonComponent = /** @class */ (function () {
    function QuestionExplainDeclineReasonComponent(utilService, toastr, spinnerService, questionService) {
        ...
        this.spinnerService = spinnerService;
        this.questionService = questionService;
        this.onUpdateSuccess = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        this.isSaving = false;
    }
    ...
    QuestionExplainDeclineReasonComponent.prototype.save = function () {
        ...
        if (!this.isUpdateMultiStatus) {
            this.spinnerService.show();
            this.questionService.updateStatus(this.questionVersionId, _models_question_model__WEBPACK_IMPORTED_MODULE_6__["QuestionStatus"].decline, this.explain.trim())
                .pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(function () { return _this.spinnerService.hide(); }))
                .subscribe(function () {
                _this.explainDeclineReasonModal.dismiss();
                _this.onUpdateSuccess.emit(_this.explain);
                _this.explain = '';
                return;
            });
        }
            ...
            var listQuestionStatus = {
                ...
                questionStatus: _models_question_model__WEBPACK_IMPORTED_MODULE_6__["QuestionStatus"].decline,
                reason: this.explain.trim(),
            };
            this.spinnerService.show();
            this.questionService.updateMultiStatus(listQuestionStatus).pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(function () { return _this.spinnerService.hide(); }))
                .subscribe(function (result) {
                var listResult = lodash__WEBPACK_IMPORTED_MODULE_7__["filter"](result, function (item) {
                    return item.code > 0;
                });
                if (listResult && result && listResult.length === result.length) {
                    _this.toastr.success('Update success');
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('explainDeclineReasonModal'),
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", Object)
    ], QuestionExplainDeclineReasonComponent.prototype, "onUpdateSuccess", void 0);
    QuestionExplainDeclineReasonComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        __metadata("design:paramtypes", [_shareds_services_util_service__WEBPACK_IMPORTED_MODULE_2__["UtilService"],
            ...
            _service_question_service__WEBPACK_IMPORTED_MODULE_4__["QuestionService"]])
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _question_detail_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./question-detail.component */ "./src/app/modules/surveys/question/question-detail/question-detail.component.ts");
...
var PageQuestionDetailComponent = /** @class */ (function (_super) {
    __extends(PageQuestionDetailComponent, _super);
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_question_detail_component__WEBPACK_IMPORTED_MODULE_1__["QuestionDetailComponent"]),
        __metadata("design:type", _question_detail_component__WEBPACK_IMPORTED_MODULE_1__["QuestionDetailComponent"])
    ], PageQuestionDetailComponent.prototype, "questionDetailComponent", void 0);
    PageQuestionDetailComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _service_question_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../service/question.service */ "./src/app/modules/surveys/question/service/question.service.ts");
/* harmony import */ var _viewmodels_question_detail_viewmodel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../viewmodels/question-detail.viewmodel */ "./src/app/modules/surveys/question/viewmodels/question-detail.viewmodel.ts");
...
/* harmony import */ var _models_question_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../models/question.model */ "./src/app/modules/surveys/question/models/question.model.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _question_approve_question_explain_decline_reason_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../question-approve/question-explain-decline-reason.component */ "./src/app/modules/surveys/question/question-approve/question-explain-decline-reason.component.ts");
...
var QuestionDetailComponent = /** @class */ (function (_super) {
    __extends(QuestionDetailComponent, _super);
    function QuestionDetailComponent(route, router, questionService) {
        var _this = _super.call(this) || this;
        _this.route = route;
        _this.router = router;
        _this.questionService = questionService;
        _this.isShowFromNotify = false;
        _this.onUpdateStatusSuccess = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        _this.onDeleteSuccess = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        _this.questionType = _models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionType"];
        _this.questionStatus = _models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionStatus"];
        return _this;
    }
    QuestionDetailComponent.prototype.ngOnInit = function () {
        this.questionDetail = new _viewmodels_question_detail_viewmodel__WEBPACK_IMPORTED_MODULE_2__["QuestionDetailViewModel"]();
    };
    ...
    QuestionDetailComponent.prototype.getDetail = function (versionId) {
        ...
        this.questionService
            .getDetail(versionId)
            .subscribe(function (result) {
            var questionDetail = result.data;
            if (questionDetail) {
                _this.questionDetail = questionDetail;
                _this.listQuestionTranslation = questionDetail.questionTranslations;
                if (questionDetail.answers) {
                    _this.listAnswer = questionDetail.answers;
                }
                if (_this.questionDetail.questionType === _models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionType"].selfResponded && _this.questionDetail.totalAnswer > 0) {
    ...
    QuestionDetailComponent.prototype.renderListQuestionSelfResponed = function (totalAnswer) {
        if (totalAnswer && totalAnswer > 0) {
            this.listAnswerSelfResponded = lodash__WEBPACK_IMPORTED_MODULE_8__["range"](1, totalAnswer + 1);
        }
        else {
    ...
    QuestionDetailComponent.prototype.updateStatus = function (status) {
        var _this = this;
        if (status === _models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionStatus"].decline) {
            this.questionExplainDeclineReasonComponent.show();
            return;
        }
        this.questionService.updateStatus(this.questionDetail.versionId, status, '').subscribe(function () {
            _this.onUpdateStatusSuccess.emit();
            _this.questionDetailModal.dismiss();
        });
    };
    QuestionDetailComponent.prototype.updateStatusSuccess = function () {
        this.onUpdateStatusSuccess.emit();
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('questionDetailModal'),
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_question_approve_question_explain_decline_reason_component__WEBPACK_IMPORTED_MODULE_7__["QuestionExplainDeclineReasonComponent"]),
        __metadata("design:type", _question_approve_question_explain_decline_reason_component__WEBPACK_IMPORTED_MODULE_7__["QuestionExplainDeclineReasonComponent"])
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", Object)
    ], QuestionDetailComponent.prototype, "onUpdateStatusSuccess", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", Object)
    ], QuestionDetailComponent.prototype, "onDeleteSuccess", void 0);
...
var QuestionDetailResolve = /** @class */ (function () {
    ...
    QuestionDetailResolve = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [])
...
/* harmony import */ var _models_question_translation_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../models/question-translation.model */ "./src/app/modules/surveys/question/models/question-translation.model.ts");
...
/* harmony import */ var _models_answer_model__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../models/answer.model */ "./src/app/modules/surveys/question/models/answer.model.ts");
/* harmony import */ var _models_answer_translation_model__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../models/answer-translation.model */ "./src/app/modules/surveys/question/models/answer-translation.model.ts");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var _answer_answer_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../answer/answer.component */ "./src/app/modules/surveys/question/answer/answer.component.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var QuestionFormComponent = /** @class */ (function (_super) {
    __extends(QuestionFormComponent, _super);
    function QuestionFormComponent(fb, toastr, numberValidator, utilService, questionService) {
        ...
        _this.listQuestionType = [];
        _this.questionGroupTree = [];
        _this.questionType = _models_question_model__WEBPACK_IMPORTED_MODULE_7__["QuestionType"];
        _this.questionStatus = _models_question_model__WEBPACK_IMPORTED_MODULE_7__["QuestionStatus"];
        _this.modelTranslation = new _models_question_translation_model__WEBPACK_IMPORTED_MODULE_5__["QuestionTranslation"]();
        _this.listAnswer = [];
        _this.buildFormLanguage = function (language) {
            ...
            var translationModel = _this.fb.group({
                ...
                name: [
                    _this.modelTranslation.name,
                    [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].maxLength(256)]
                ],
                content: [_this.modelTranslation.content,
                    [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].maxLength(4000)]],
                explain: [
                    _this.modelTranslation.explain,
                    [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].maxLength(4000)]
                ]
            });
            translationModel.valueChanges.subscribe(function (data) {
    ...
    QuestionFormComponent.prototype.ngOnInit = function () {
        this.question = new _models_question_model__WEBPACK_IMPORTED_MODULE_7__["Question"]();
        this.renderForm();
    };
    ...
    QuestionFormComponent.prototype.save = function (type) {
        var _this = this;
        var isSend = type === 2;
        var isValid = this.utilService.onValueChanged(this.model, this.formErrors, this.validationMessages, true);
        var isLanguageValid = this.checkLanguageValid();
        if (isValid && isLanguageValid) {
            ...
            if (this.type === _models_question_model__WEBPACK_IMPORTED_MODULE_7__["QuestionType"].singleChoice || this.type === _models_question_model__WEBPACK_IMPORTED_MODULE_7__["QuestionType"].multiChoice) {
                this.checkListAnswer(this.listAnswer);
                if (!this.listAnswer || this.listAnswer.length < 2) {
                    this.toastr.error('Question has least 2 answer.');
                    return;
                }
                var listAnswerCorrect = lodash__WEBPACK_IMPORTED_MODULE_13__["filter"](this.listAnswer, function (item) {
                    return item.isCorrect;
                });
            ...
            this.question.answers = this.type === _models_question_model__WEBPACK_IMPORTED_MODULE_7__["QuestionType"].essay || this.type === _models_question_model__WEBPACK_IMPORTED_MODULE_7__["QuestionType"].selfResponded ? [] : this.listAnswer;
            this.isSaving = true;
            if (this.isUpdate) {
                this.questionService.update(isSend, this.questionId, this.questionVersionId, this.question).pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_9__["finalize"])(function () {
                ...
                this.questionService.insert(isSend, this.question).pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_9__["finalize"])(function () {
                    _this.isSaving = false;
                })).subscribe(function () {
                    _this.isModified = true;
                    if (_this.isCreateAnother) {
    ...
    QuestionFormComponent.prototype.add = function () {
        this.type = _models_question_model__WEBPACK_IMPORTED_MODULE_7__["QuestionType"].singleChoice;
    ...
    QuestionFormComponent.prototype.send = function () {
        var _this = this;
        this.questionService.updateStatus(this.questionVersionId, _models_question_model__WEBPACK_IMPORTED_MODULE_7__["QuestionStatus"].pending, '').subscribe(function () {
            _this.questionFormModal.dismiss();
        });
    };
    QuestionFormComponent.prototype.selectLanguage = function (value) {
        if (value) {
            this.currentLanguage = value.id;
        }
    };
    QuestionFormComponent.prototype.selectQuestionType = function (value) {
        if (value) {
            if (this.model.value.questionType) {
                if (this.listAnswer && this.listAnswer.length > 0) {
                    lodash__WEBPACK_IMPORTED_MODULE_13__["each"](this.listAnswer, function (item) {
                        item.isCorrect = false;
                    });
                }
            }
    ...
    QuestionFormComponent.prototype.checkListAnswer = function (listAnswer) {
        if (listAnswer && listAnswer.length > 0) {
            ...
            lodash__WEBPACK_IMPORTED_MODULE_13__["each"](this.listAnswer, function (item) {
                var answerTranslation = lodash__WEBPACK_IMPORTED_MODULE_13__["filter"](item.answerTranslations, function (translation) {
    ...
    QuestionFormComponent.prototype.getDetail = function (versionId) {
        ...
        this.subscribers.questionService = this.questionService
            ...
            if (questionDetail) {
                ...
                _this.type = questionDetail.questionType;
                if (questionDetail.answers) {
                    _this.listAnswer = questionDetail.answers;
                }
                if (questionDetail.questionTranslations && questionDetail.questionTranslations.length > 0) {
                    _this.modelTranslations.controls.forEach(function (model) {
                        var detail = lodash__WEBPACK_IMPORTED_MODULE_13__["find"](questionDetail.questionTranslations, function (questionTranslation) {
    ...
    QuestionFormComponent.prototype.insertListAnswerDefault = function () {
        if ((!this.listAnswer || this.listAnswer.length === 0) && this.languages) {
            var answerLength = this.type === _models_question_model__WEBPACK_IMPORTED_MODULE_7__["QuestionType"].singleChoice
                || this.type === _models_question_model__WEBPACK_IMPORTED_MODULE_7__["QuestionType"].multiChoice ? 4 : this.type === _models_question_model__WEBPACK_IMPORTED_MODULE_7__["QuestionType"].vote
                && this.model.value.score ? this.model.value.score : 1;
            var _loop_1 = function (i) {
                var answer = new _models_answer_model__WEBPACK_IMPORTED_MODULE_11__["Answer"]();
                lodash__WEBPACK_IMPORTED_MODULE_13__["each"](this_1.languages, function (item, index) {
                    var answerTranslation = new _models_answer_translation_model__WEBPACK_IMPORTED_MODULE_12__["AnswerTranslation"]();
                    answerTranslation.languageId = item.id;
                    answerTranslation.name = '';
                    answer.answerTranslations.push(answerTranslation);
                });
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('questionFormModal'),
        __metadata("design:type", _shareds_components_nh_modal_nh_modal_component__WEBPACK_IMPORTED_MODULE_3__["NhModalComponent"])
    ], QuestionFormComponent.prototype, "questionFormModal", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_answer_answer_component__WEBPACK_IMPORTED_MODULE_14__["AnswerComponent"]),
        __metadata("design:type", _answer_answer_component__WEBPACK_IMPORTED_MODULE_14__["AnswerComponent"])
    ...
    QuestionFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [_service_question_service__WEBPACK_IMPORTED_MODULE_2__["QuestionService"], _shareds_services_util_service__WEBPACK_IMPORTED_MODULE_6__["UtilService"], _validators_number_validator__WEBPACK_IMPORTED_MODULE_8__["NumberValidator"], ngx_toastr__WEBPACK_IMPORTED_MODULE_10__["ToastrService"]]
        }),
...
/* harmony import */ var _shareds_components_nh_modal_nh_modal_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../shareds/components/nh-modal/nh-modal.component */ "./src/app/shareds/components/nh-modal/nh-modal.component.ts");
/* harmony import */ var _service_question_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../service/question.service */ "./src/app/modules/surveys/question/service/question.service.ts");
/* harmony import */ var _question_group_service_question_group_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../question-group/service/question-group.service */ "./src/app/modules/surveys/question-group/service/question-group.service.ts");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_4__);
...
var QuestionSelectComponent = /** @class */ (function () {
    function QuestionSelectComponent(toastr, questionService, questionGroupService) {
        ...
        this.totalQuestionGroupRows = 0;
        this.currentQuestionPage = 0;
        this.currentQuestionGroupPage = 0;
    ...
    Object.defineProperty(QuestionSelectComponent.prototype, "listSelectedQuestions", {
        ...
        set: function (value) {
            this._listSelectedQuestions = lodash__WEBPACK_IMPORTED_MODULE_4__["cloneDeep"](value);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(QuestionSelectComponent.prototype, "listSelectedQuestionGroups", {
        ...
        set: function (value) {
            this._listSelectedQuestionGroups = lodash__WEBPACK_IMPORTED_MODULE_4__["cloneDeep"](value);
        },
        enumerable: true,
        configurable: true
    });
    ...
    QuestionSelectComponent.prototype.show = function () {
        this.questionSelectModal.open();
        this.viewType = 0;
        this.calculateTotalSelectedQuestion();
        this.searchQuestion(1);
    };
    QuestionSelectComponent.prototype.changeViewType = function (viewType) {
    ...
    QuestionSelectComponent.prototype.questionGroupChangeTotalQuestion = function (questionGroup, value) {
        questionGroup.totalQuestion = +value;
        this.calculateTotalSelectedQuestion();
    };
    QuestionSelectComponent.prototype.selectQuestion = function (question) {
        var selectedQuestion = lodash__WEBPACK_IMPORTED_MODULE_4__["find"](this.listSelectedQuestions, function (item) {
    ...
    QuestionSelectComponent.prototype.selectQuestionGroup = function (questionGroup) {
        var selectedQuestionGroup = lodash__WEBPACK_IMPORTED_MODULE_4__["find"](this.listSelectedQuestionGroups, function (item) {
    ...
    QuestionSelectComponent.prototype.refreshSearchQuestion = function () {
        this.questionKeyword = '';
        this.questionGroupId = null;
        this.searchQuestion(1);
    };
    QuestionSelectComponent.prototype.refreshSearchQuestionQuestion = function () {
        this.questionGroupKeyword = '';
        this.searchQuestionGroup(1);
    };
    QuestionSelectComponent.prototype.removeQuestion = function (question) {
        lodash__WEBPACK_IMPORTED_MODULE_4__["remove"](this.listSelectedQuestions, function (item) {
            return item.id === question.id;
        });
        var questionInfo = lodash__WEBPACK_IMPORTED_MODULE_4__["find"](this.listQuestions, function (item) {
            return item.id === question.id;
        });
        if (questionInfo) {
    ...
    QuestionSelectComponent.prototype.removeQuestionGroup = function (questionGroup) {
        lodash__WEBPACK_IMPORTED_MODULE_4__["remove"](this.listSelectedQuestionGroups, function (item) {
            return item.id === questionGroup.id;
        });
        var questionGroupInfo = lodash__WEBPACK_IMPORTED_MODULE_4__["find"](this.listQuestionGroups, function (item) {
            return item.id === questionGroup.id;
        });
    ...
    QuestionSelectComponent.prototype.searchQuestion = function (currentPage) {
        var _this = this;
        ...
        this.questionService.searchForSuggestion(this.questionKeyword, this.questionGroupId, this.currentQuestionPage, this.pageSize)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["finalize"])(function () { return _this.isSearching = false; }))
            .subscribe(function (result) {
            _this.totalQuestionRows = result.totalRows;
            lodash__WEBPACK_IMPORTED_MODULE_4__["each"](result.items, function (item) {
                var selectedItem = lodash__WEBPACK_IMPORTED_MODULE_4__["find"](_this.listSelectedQuestions, function (question) {
    ...
    QuestionSelectComponent.prototype.searchQuestionGroup = function (currentPage) {
        var _this = this;
        ...
        this.questionGroupService.searchForSelect(this.questionGroupKeyword, this.currentQuestionGroupPage, this.pageSize)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["finalize"])(function () { return _this.isSearching = false; }))
            .subscribe(function (result) {
            _this.totalQuestionGroupRows = result.totalRows;
            lodash__WEBPACK_IMPORTED_MODULE_4__["each"](result.items, function (item) {
                var selectedItem = lodash__WEBPACK_IMPORTED_MODULE_4__["find"](_this.listSelectedQuestionGroups, function (question) {
                    return question.id === item.id;
                });
                item.isSelected = selectedItem != null && selectedItem !== undefined;
            });
            _this.listQuestionGroups = result.items;
        });
    };
    ...
    QuestionSelectComponent.prototype.calculateTotalSelectedQuestion = function () {
        ...
        var totalSelectedQuestionGroups = lodash__WEBPACK_IMPORTED_MODULE_4__["sumBy"](this.listSelectedQuestionGroups, function (item) {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('questionSelectModal'),
        __metadata("design:type", _shareds_components_nh_modal_nh_modal_component__WEBPACK_IMPORTED_MODULE_1__["NhModalComponent"])
    ...
    QuestionSelectComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        __metadata("design:paramtypes", [ngx_toastr__WEBPACK_IMPORTED_MODULE_5__["ToastrService"],
            _service_question_service__WEBPACK_IMPORTED_MODULE_2__["QuestionService"],
            _question_group_service_question_group_service__WEBPACK_IMPORTED_MODULE_3__["QuestionGroupService"]])
...
/* harmony import */ var _models_question_model__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./models/question.model */ "./src/app/modules/surveys/question/models/question.model.ts");
...
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var _question_form_question_form_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./question-form/question-form.component */ "./src/app/modules/surveys/question/question-form/question-form.component.ts");
...
var QuestionComponent = /** @class */ (function (_super) {
    ...
    function QuestionComponent(pageId, appConfig, location, route, router, toastr, cdr, questionService, helperService, questionGroupService, utilService) {
        ...
        _this.questionGroupService = questionGroupService;
        _this.utilService = utilService;
        _this.questionType = _models_question_model__WEBPACK_IMPORTED_MODULE_11__["QuestionType"]; // Loại câu hỏi
        _this.questionStatus = _models_question_model__WEBPACK_IMPORTED_MODULE_11__["QuestionStatus"]; // Trạng thái phê duyệt
        _this.isSelectAll = false;
        _this.isSelectQuestion = false;
        _this.listQuestionType = [
            { id: _models_question_model__WEBPACK_IMPORTED_MODULE_11__["QuestionType"].singleChoice, name: 'SingleChoice' },
            { id: _models_question_model__WEBPACK_IMPORTED_MODULE_11__["QuestionType"].multiChoice, name: 'MultiChoice' },
            { id: _models_question_model__WEBPACK_IMPORTED_MODULE_11__["QuestionType"].essay, name: 'Essay' },
            { id: _models_question_model__WEBPACK_IMPORTED_MODULE_11__["QuestionType"].vote, name: 'Vote' },
            {
                id: _models_question_model__WEBPACK_IMPORTED_MODULE_11__["QuestionType"].selfResponded, name: 'Self Responded'
            }
        ];
        _this.listQuestionStatus = [
            { id: _models_question_model__WEBPACK_IMPORTED_MODULE_11__["QuestionStatus"].draft, name: 'Draft' },
            { id: _models_question_model__WEBPACK_IMPORTED_MODULE_11__["QuestionStatus"].pending, name: 'Pending' },
            { id: _models_question_model__WEBPACK_IMPORTED_MODULE_11__["QuestionStatus"].approved, name: 'Approved' },
            { id: _models_question_model__WEBPACK_IMPORTED_MODULE_11__["QuestionStatus"].decline, name: 'Decline' }
        ];
        return _this;
    }
    ...
    QuestionComponent.prototype.delete = function (versionId) {
        var _this = this;
        this.questionService.delete(versionId).subscribe(function () {
            lodash__WEBPACK_IMPORTED_MODULE_13__["remove"](_this.listQuestion, function (item) {
    ...
    QuestionComponent.prototype.deleteMultiQuestion = function () {
        ...
        var listQuestionVersionIdDraftSelect = lodash__WEBPACK_IMPORTED_MODULE_13__["map"](lodash__WEBPACK_IMPORTED_MODULE_13__["filter"](this.listQuestion, function (item) {
            return item.isCheck && (item.questionStatus === _models_question_model__WEBPACK_IMPORTED_MODULE_11__["QuestionStatus"].draft || item.questionStatus === _models_question_model__WEBPACK_IMPORTED_MODULE_11__["QuestionStatus"].decline);
        }), (function (questionSelect) {
            return questionSelect.versionId;
        }));
        if (!listQuestionVersionIdDraftSelect || listQuestionVersionIdDraftSelect.length === 0) {
    ...
    QuestionComponent.prototype.sendMultiQuestion = function () {
        ...
        var listQuestionUpdateStatus = {
            questionVersionIds: listQuestionVersionIdDraftSelect,
            questionStatus: _models_question_model__WEBPACK_IMPORTED_MODULE_11__["QuestionStatus"].pending,
            reason: '',
        };
    ...
    QuestionComponent.prototype.send = function (question) {
        this.questionService.updateStatus(question.versionId, _models_question_model__WEBPACK_IMPORTED_MODULE_11__["QuestionStatus"].pending, '').subscribe(function () {
            question.questionStatus = _models_question_model__WEBPACK_IMPORTED_MODULE_11__["QuestionStatus"].pending;
    ...
    QuestionComponent.prototype.checkAll = function () {
        var _this = this;
        if (this.listQuestion) {
            lodash__WEBPACK_IMPORTED_MODULE_13__["each"](this.listQuestion, function (item) {
                item.isCheck = _this.isSelectAll;
            });
            this.getQuestionVersionIdSelect();
        }
    ...
    QuestionComponent.prototype.renderFilterLink = function () {
        var path = 'surveys/question';
        var query = this.utilService.renderLocationFilter([
            new _shareds_models_filter_link_model__WEBPACK_IMPORTED_MODULE_15__["FilterLink"]('keyword', this.keyword),
            new _shareds_models_filter_link_model__WEBPACK_IMPORTED_MODULE_15__["FilterLink"]('questionType', this.type),
            new _shareds_models_filter_link_model__WEBPACK_IMPORTED_MODULE_15__["FilterLink"]('questionGroupId', this.questionGroupId),
            new _shareds_models_filter_link_model__WEBPACK_IMPORTED_MODULE_15__["FilterLink"]('creatorId', this.userIdSearch),
            new _shareds_models_filter_link_model__WEBPACK_IMPORTED_MODULE_15__["FilterLink"]('questionStatus', this.status),
            new _shareds_models_filter_link_model__WEBPACK_IMPORTED_MODULE_15__["FilterLink"]('page', this.currentPage),
    ...
    QuestionComponent.prototype.getQuestionVersionIdSelect = function () {
        this.listQuestionVersionIdSelect = lodash__WEBPACK_IMPORTED_MODULE_13__["map"](lodash__WEBPACK_IMPORTED_MODULE_13__["filter"](this.listQuestion, function (item) {
            return item.isCheck;
        }), (function (questionSelect) {
            return questionSelect.versionId;
        }));
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_question_form_question_form_component__WEBPACK_IMPORTED_MODULE_14__["QuestionFormComponent"]),
        __metadata("design:type", _question_form_question_form_component__WEBPACK_IMPORTED_MODULE_14__["QuestionFormComponent"])
    ], QuestionComponent.prototype, "questionFormComponent", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_question_detail_question_detail_component__WEBPACK_IMPORTED_MODULE_16__["QuestionDetailComponent"]),
        __metadata("design:type", _question_detail_question_detail_component__WEBPACK_IMPORTED_MODULE_16__["QuestionDetailComponent"])
    ...
    QuestionComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["Location"], { provide: _angular_common__WEBPACK_IMPORTED_MODULE_2__["LocationStrategy"], useClass: _angular_common__WEBPACK_IMPORTED_MODULE_2__["PathLocationStrategy"] },
                _service_question_service__WEBPACK_IMPORTED_MODULE_1__["QuestionService"], _shareds_services_helper_service__WEBPACK_IMPORTED_MODULE_7__["HelperService"], _question_group_service_question_group_service__WEBPACK_IMPORTED_MODULE_12__["QuestionGroupService"]]
        }),
        ...
        __param(1, Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Inject"])(_configs_app_config__WEBPACK_IMPORTED_MODULE_6__["APP_CONFIG"])),
        __metadata("design:paramtypes", [Object, Object, _angular_common__WEBPACK_IMPORTED_MODULE_2__["Location"],
...
/* harmony import */ var _models_question_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/question.model */ "./src/app/modules/surveys/question/models/question.model.ts");
...
var QuestionApproveService = /** @class */ (function () {
    ...
    QuestionApproveService.prototype.resolve = function (route, state) {
        var queryParams = route.queryParams;
        return this.search(queryParams.keyword, queryParams.questionType, queryParams.questionGroupId, queryParams.creatorId, queryParams.questionStatus, queryParams.page, queryParams.pageSize);
    };
    QuestionApproveService.prototype.search = function (keyword, questionType, questionGroupId, creatorId, questionStatus, page, pageSize) {
        ...
        return this.http.get(this.url + "approves", {
            ...
            if (result.items) {
                result.items.forEach(function (item) {
                    item.isCheck = false;
                    item.statusName = item.questionStatus === _models_question_model__WEBPACK_IMPORTED_MODULE_2__["QuestionStatus"].draft ? 'Draft' :
                        item.questionStatus === _models_question_model__WEBPACK_IMPORTED_MODULE_2__["QuestionStatus"].pending ? 'Pending' :
                            item.questionStatus === _models_question_model__WEBPACK_IMPORTED_MODULE_2__["QuestionStatus"].approved ? 'Approved' :
                                item.questionStatus === _models_question_model__WEBPACK_IMPORTED_MODULE_2__["QuestionStatus"].decline ? 'Decline' : '';
                    item.typeName = item.questionType === _models_question_model__WEBPACK_IMPORTED_MODULE_2__["QuestionType"].singleChoice ? 'Single Choice' :
                        item.questionType === _models_question_model__WEBPACK_IMPORTED_MODULE_2__["QuestionType"].multiChoice ? 'Multi Choice' :
                            item.questionType === _models_question_model__WEBPACK_IMPORTED_MODULE_2__["QuestionType"].essay ? 'Essay' :
                                item.questionType === _models_question_model__WEBPACK_IMPORTED_MODULE_2__["QuestionType"].vote ? 'Vote' :
                                    item.questionType === _models_question_model__WEBPACK_IMPORTED_MODULE_2__["QuestionType"].selfResponded ? 'Self Responded' : '';
                });
            }
            return result;
        }));
    ...
    QuestionApproveService = __decorate([
        __param(0, Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Inject"])(_configs_app_config__WEBPACK_IMPORTED_MODULE_3__["APP_CONFIG"])),
...
var QuestionService = /** @class */ (function () {
    ...
    QuestionService.prototype.search = function (keyword, questionType, questionGroupId, creatorId, questionStatus, page, pageSize) {
        ...
        return this.http.get("" + this.url, {
            ...
            if (result.items) {
                result.items.forEach(function (item) {
                    item.isCheck = false;
                    item.statusName = item.questionStatus === _models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionStatus"].draft ? 'Draft' :
                        item.questionStatus === _models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionStatus"].pending ? 'Pending' :
                            item.questionStatus === _models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionStatus"].approved ? 'Approved' :
                                item.questionStatus === _models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionStatus"].decline ? 'Decline' : '';
                    item.typeName = item.questionType === _models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionType"].singleChoice ? 'Single Choice' :
                        item.questionType === _models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionType"].multiChoice ? 'Multi Choice' :
                            item.questionType === _models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionType"].essay ? 'Essay' :
                                item.questionType === _models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionType"].vote ? 'Vote' :
                                    item.questionType === _models_question_model__WEBPACK_IMPORTED_MODULE_5__["QuestionType"].selfResponded ? 'Self Responded' : '';
                });
            }
            return result;
        }));
    ...
    QuestionService.prototype.getDetail = function (versionId) {
        ...
        return this.http.get("" + this.url + versionId, {})
            .pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_7__["finalize"])(function () { return _this.spinnerService.hide(); }));
    };
    ...
    QuestionService.prototype.searchForSuggestion = function (keyword, questionGroupId, page, pageSize) {
        if (page === void 0) { page = 1; }
    ...
    QuestionService = __decorate([
        __param(0, Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Inject"])(_configs_app_config__WEBPACK_IMPORTED_MODULE_2__["APP_CONFIG"])),
...
module.exports = "<nh-modal #surveyGroupFormModal size=\"md\"\r\n          (show)=\"onModalShow()\"\r\n          (hidden)=\"onModalHidden()\">\r\n    <nh-modal-header>\r\n        {isUpdate, select, 0 {Add new survey group} 1 {Update survey group} other {}}\r\n    </nh-modal-header>\r\n    <form class=\"form-horizontal\" (ngSubmit)=\"save()\" [formGroup]=\"model\">\r\n        <nh-modal-content>\r\n            <div class=\"col-sm-12\">\r\n                <div formArrayName=\"modelTranslations\">\r\n                    <div class=\"form-group\" *ngIf=\"languages && languages.length > 1\">\r\n                        <label i18n-ghmLabel=\"@@language\" ghmLabel=\"Language\"\r\n                               class=\"col-sm-4 control-label\"></label>\r\n                        <div class=\"col-sm-8\">\r\n                            <nh-select [data]=\"languages\"\r\n                                       i18n-title=\"@@pleaseSelectLanguage\"\r\n                                       title=\"-- Please select language --\"\r\n                                       name=\"language\"\r\n                                       [(value)]=\"currentLanguage\"\r\n                                       (onSelectItem)=\"currentLanguage = $event.id\"></nh-select>\r\n                        </div>\r\n                    </div>\r\n                    <div class=\"form-group cm-mgb-10\"\r\n                         *ngFor=\"let modelTranslation of modelTranslations.controls; index as i\"\r\n                         [hidden]=\"modelTranslation.value.languageId !== currentLanguage\"\r\n                         [formGroupName]=\"i\"\r\n                         [class.has-error]=\"translationFormErrors[modelTranslation.value.languageId]?.name\">\r\n                        <label i18n-ghmLabel=\"@@surveyGroupName\" ghmLabel=\"Survey Group Name\"\r\n                               class=\"col-sm-4 control-label\" [required]=\"true\"></label>\r\n                        <div class=\"col-sm-8\">\r\n                            <input type=\"text\" class=\"form-control\"\r\n                                   i18n-placeholder=\"@@enterSurveyGroupNamePlaceHolder\"\r\n                                   placeholder=\"Enter survey group name.\"\r\n                                   formControlName=\"name\">\r\n                            <span class=\"help-block\">\r\n                                                    { translationFormErrors[modelTranslation.value.languageId]?.name, select, required {Survey name is required} maxlength {Survey group name\r\n                                                    name not allowed over 256 characters} }\r\n                                            </span>\r\n                        </div>\r\n                    </div>\r\n                    <div class=\"form-group cm-mgb-10\">\r\n                        <label i18n=\"@@surveyGroup\" i18n-ghmLabel ghmLabel=\"Survey Group\"\r\n                               class=\"col-sm-4 control-label\"></label>\r\n                        <div class=\"col-sm-8\" [formGroup]=\"model\">\r\n                            <nh-dropdown-tree\r\n                                [width]=\"500\"\r\n                                [data]=\"surveyGroupTree\" i18n=\"@@surveyQuestionGroup\"\r\n                                i18n-title\r\n                                title=\"-- Select survey group --\"\r\n                                formControlName=\"parentId\">\r\n                            </nh-dropdown-tree>\r\n                        </div>\r\n                    </div>\r\n                    <div class=\"form-group cm-mgb-10\"\r\n                         [hidden]=\"modelTranslation.value.languageId !== currentLanguage\"\r\n                         *ngFor=\"let modelTranslation of modelTranslations.controls; index as i\"\r\n                         [formGroupName]=\"i\"\r\n                         [class.has-error]=\"translationFormErrors[modelTranslation.value.languageId]?.description\">\r\n                        <label i18n=\"@@description\" i18n-ghmLabel ghmLabel=\"Description\"\r\n                               class=\"col-sm-4 control-label\"></label>\r\n                        <div class=\"col-sm-8\">\r\n                                                <textarea class=\"form-control\" rows=\"3\" formControlName=\"description\"\r\n                                                          i18n=\"@@enterDescriptionPlaceholder\" i18n-placeholder\r\n                                                          placeholder=\"Enter description.\"></textarea>\r\n                            <span class=\"help-block\">\r\n                                                    {translationFormErrors[modelTranslation.value.languageId]?.description, select, maxlength {Survey group description not allowed\r\n                                                    over 500 characters}}\r\n                                                </span>\r\n                        </div>\r\n                    </div>\r\n                    <div class=\"form-group cm-mgb-10\" [formGroup]=\"model\">\r\n                        <div class=\"col-sm-8 col-sm-offset-4\">\r\n                            <mat-checkbox color=\"primary\" formControlName=\"isActive\" i18n=\"@@isActive\">\r\n                                {model.value.isActive, select, 0 {Inactive} 1 {Active}}\r\n                            </mat-checkbox>\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n        </nh-modal-content>\r\n        <nh-modal-footer>\r\n            <mat-checkbox [checked]=\"isCreateAnother\" (change)=\"isCreateAnother = !isCreateAnother\"\r\n                          *ngIf=\"!isUpdate\"\r\n                          i18n=\"@@isCreateAnother\"\r\n                          class=\"cm-mgr-5\"\r\n                          color=\"primary\">\r\n                Create another\r\n            </mat-checkbox>\r\n            <ghm-button classes=\"btn btn-primary cm-mgr-5\"\r\n                        [loading]=\"isSaving\">\r\n                <span i18n=\"@@Save\">Save</span>\r\n            </ghm-button>\r\n            <ghm-button classes=\"btn btn-default\"\r\n                        nh-dismiss=\"true\"\r\n                        [type]=\"'button'\"\r\n                        [loading]=\"isSaving\">\r\n                <span i18n=\"@@close\">Close</span>\r\n            </ghm-button>\r\n        </nh-modal-footer>\r\n    </form>\r\n</nh-modal>\r\n"
...
/* harmony import */ var _base_form_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../base-form.component */ "./src/app/base-form.component.ts");
...
/* harmony import */ var _models_survey_group_model__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../models/survey-group.model */ "./src/app/modules/surveys/survey-group/models/survey-group.model.ts");
/* harmony import */ var _models_survey_group_translation_model__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../models/survey-group-translation.model */ "./src/app/modules/surveys/survey-group/models/survey-group-translation.model.ts");
/* harmony import */ var _services_survey_group_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../services/survey-group.service */ "./src/app/modules/surveys/survey-group/services/survey-group.service.ts");
...
var SurveyGroupFormComponent = /** @class */ (function (_super) {
    __extends(SurveyGroupFormComponent, _super);
    function SurveyGroupFormComponent(pageId, fb, toastr, spinnerService, surveyGroupService, utilService) {
        var _this = _super.call(this) || this;
        _this.fb = fb;
        _this.toastr = toastr;
        _this.spinnerService = spinnerService;
        ...
        _this.modelTranslation = new _models_survey_group_translation_model__WEBPACK_IMPORTED_MODULE_9__["SurveyGroupTranslation"]();
        _this.isGettingTree = false;
        _this.buildFormLanguage = function (language) {
            _this.translationFormErrors[language] = _this.utilService.renderFormError(['name', 'description']);
            _this.translationValidationMessage[language] = _this.utilService.renderFormErrorMessage([
    ...
    SurveyGroupFormComponent.prototype.ngOnInit = function () {
        this.surveyGroup = new _models_survey_group_model__WEBPACK_IMPORTED_MODULE_8__["SurveyGroup"]();
        this.renderForm();
        this.getSurveyTree();
    };
        ...
        this.subscribers.surveyGroupService = this.surveyGroupService
            ...
            if (surveyGroupDetail) {
                ...
                if (surveyGroupDetail.surveyGroupTranslations && surveyGroupDetail.surveyGroupTranslations.length > 0) {
                    _this.modelTranslations.controls.forEach(function (model) {
                        var detail = lodash__WEBPACK_IMPORTED_MODULE_12__["find"](surveyGroupDetail.surveyGroupTranslations, function (questionGroupTranslation) {
                            return (questionGroupTranslation.languageId ===
                                model.value.languageId);
                        });
                        if (detail) {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('surveyGroupFormModal'),
    ...
    SurveyGroupFormComponent = __decorate([
        ...
        __param(0, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_configs_page_id_config__WEBPACK_IMPORTED_MODULE_6__["PAGE_ID"])),
        __metadata("design:paramtypes", [Object, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"],
            ngx_toastr__WEBPACK_IMPORTED_MODULE_7__["ToastrService"],
            _core_spinner_spinner_service__WEBPACK_IMPORTED_MODULE_3__["SpinnerService"],
            _services_survey_group_service__WEBPACK_IMPORTED_MODULE_10__["SurveyGroupService"],
...
}(_base_form_component__WEBPACK_IMPORTED_MODULE_0__["BaseFormComponent"]));
...
/* harmony import */ var _services_survey_group_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./services/survey-group.service */ "./src/app/modules/surveys/survey-group/services/survey-group.service.ts");
/* harmony import */ var _shareds_services_util_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../shareds/services/util.service */ "./src/app/shareds/services/util.service.ts");
...
/* harmony import */ var _survey_group_form_survey_group_form_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./survey-group-form/survey-group-form.component */ "./src/app/modules/surveys/survey-group/survey-group-form/survey-group-form.component.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var SurveyGroupComponent = /** @class */ (function (_super) {
    __extends(SurveyGroupComponent, _super);
    ...
    SurveyGroupComponent.prototype.search = function (currentPage) {
        ...
        this.listItems$ = this.surveyGroupService.search(this.keyword, this.isActive, this.currentPage, this.pageSize)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["finalize"])(function () { return _this.isSearching = false; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["map"])(function (data) {
            _this.totalRows = data.totalRows;
            return data.items;
        }));
    };
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_survey_group_form_survey_group_form_component__WEBPACK_IMPORTED_MODULE_12__["SurveyGroupFormComponent"]),
        __metadata("design:type", _survey_group_form_survey_group_form_component__WEBPACK_IMPORTED_MODULE_12__["SurveyGroupFormComponent"])
    ...
    SurveyGroupComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [
                ...
                _shareds_services_helper_service__WEBPACK_IMPORTED_MODULE_2__["HelperService"], _services_survey_group_service__WEBPACK_IMPORTED_MODULE_3__["SurveyGroupService"]
            ]
        }),
        __param(0, Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Inject"])(_configs_page_id_config__WEBPACK_IMPORTED_MODULE_6__["PAGE_ID"])),
        ...
        __metadata("design:paramtypes", [Object, Object, _angular_common__WEBPACK_IMPORTED_MODULE_1__["Location"],
            ...
            ngx_toastr__WEBPACK_IMPORTED_MODULE_10__["ToastrService"],
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"],
            _services_survey_group_service__WEBPACK_IMPORTED_MODULE_3__["SurveyGroupService"],
...
var SurveyReportByUserDetailComponent = /** @class */ (function () {
    function SurveyReportByUserDetailComponent(surveyReportService) {
    ...
    SurveyReportByUserDetailComponent.prototype.changeView = function (viewType) {
        ...
        this.viewType = viewType;
        if (this.viewType === 1) {
            var series = this.listQuestionGroups.map(function (questionGroup) {
                return {
                    name: questionGroup.questionGroupName,
                    data: []
                };
            });
            this.groupChart = new angular_highcharts__WEBPACK_IMPORTED_MODULE_2__["Chart"]({
                chart: {
                    type: 'column'
                },
                title: {
                ...
                xAxis: {
                    categories: this.listQuestionGroups.map(function (questionGroup) {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('surveyUserReportByGroupModal'),
        __metadata("design:type", _shareds_components_nh_modal_nh_modal_component__WEBPACK_IMPORTED_MODULE_1__["NhModalComponent"])
    ], SurveyReportByUserDetailComponent.prototype, "surveyUserReportByGroupModal", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_do_exam_exam_detail_exam_deatil_component__WEBPACK_IMPORTED_MODULE_4__["ExamDetailComponent"]),
        __metadata("design:type", _do_exam_exam_detail_exam_deatil_component__WEBPACK_IMPORTED_MODULE_4__["ExamDetailComponent"])
    ], SurveyReportByUserDetailComponent.prototype, "examDetailComponent", void 0);
    SurveyReportByUserDetailComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        __metadata("design:paramtypes", [_survey_report_service__WEBPACK_IMPORTED_MODULE_3__["SurveyReportService"]])
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shareds_components_nh_modal_nh_modal_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../shareds/components/nh-modal/nh-modal.component */ "./src/app/shareds/components/nh-modal/nh-modal.component.ts");
/* harmony import */ var _survey_report_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../survey-report.service */ "./src/app/modules/surveys/survey-report/survey-report.service.ts");
/* harmony import */ var _survey_report_by_user_detail_survey_report_by_user_detail_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../survey-report-by-user-detail/survey-report-by-user-detail.component */ "./src/app/modules/surveys/survey-report/survey-report-by-user-detail/survey-report-by-user-detail.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SurveyReportUserAnswerTimesComponent = /** @class */ (function () {
    function SurveyReportUserAnswerTimesComponent(surveyReportService) {
        this.surveyReportService = surveyReportService;
    }
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('surveyUserAnswerTimesModal'),
        __metadata("design:type", _shareds_components_nh_modal_nh_modal_component__WEBPACK_IMPORTED_MODULE_1__["NhModalComponent"])
    ], SurveyReportUserAnswerTimesComponent.prototype, "surveyUserAnswerTimesModal", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('surveyReportByUserDetail'),
        __metadata("design:type", _survey_report_by_user_detail_survey_report_by_user_detail_component__WEBPACK_IMPORTED_MODULE_3__["SurveyReportByUserDetailComponent"])
    ], SurveyReportUserAnswerTimesComponent.prototype, "surveyReportByUserDetailComponent", void 0);
    SurveyReportUserAnswerTimesComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        __metadata("design:paramtypes", [_survey_report_service__WEBPACK_IMPORTED_MODULE_2__["SurveyReportService"]])
...
/* harmony import */ var _survey_report_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./survey-report.service */ "./src/app/modules/surveys/survey-report/survey-report.service.ts");
...
var SurveyReportComponent = /** @class */ (function (_super) {
    __extends(SurveyReportComponent, _super);
    ...
    SurveyReportComponent.prototype.ngOnInit = function () {
        ...
        this.subscribers.searchGroupTree = this.surveyGroupService.getTree()
            .subscribe(function (result) { return _this.surveyGroupTree = result; });
        this.listItems$ = this.route.data.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (result) {
            var data = result.data;
            if (data) {
                _this.totalRows = data.totalRows;
                return data.items;
    ...
    SurveyReportComponent.prototype.search = function (currentPage) {
        ...
        this.listItems$ = this.surveyReportService
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["finalize"])(function () { return _this.isSearching = false; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (result) {
            _this.totalRows = result.totalRows;
            return result.items;
        }));
    };
    SurveyReportComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [_survey_report_service__WEBPACK_IMPORTED_MODULE_5__["SurveyReportService"]]
        }),
        ...
        __metadata("design:paramtypes", [Object, _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"],
            _survey_group_services_survey_group_service__WEBPACK_IMPORTED_MODULE_6__["SurveyGroupService"],
            _survey_report_service__WEBPACK_IMPORTED_MODULE_5__["SurveyReportService"]])
...
var SurveyReportService = /** @class */ (function () {
    function SurveyReportService(appConfig, http, spinnerService) {
        this.http = http;
        this.spinnerService = spinnerService;
        this.url = 'reports/';
        this.url = "" + appConfig.SURVEY_API_URL + this.url;
    ...
    SurveyReportService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var _survey_report_user_answer_times_survey_report_user_answer_times_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../survey-report-user-answer-times/survey-report-user-answer-times.component */ "./src/app/modules/surveys/survey-report/survey-report-user-answer-times/survey-report-user-answer-times.component.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var SurveyUserReportComponent = /** @class */ (function (_super) {
    __extends(SurveyUserReportComponent, _super);
    function SurveyUserReportComponent(router, route, surveyReportService) {
        var _this = _super.call(this) || this;
        _this.router = router;
        _this.route = route;
        _this.surveyReportService = surveyReportService;
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('surveyReportUserAnswerTimesComponent'),
        __metadata("design:type", _survey_report_user_answer_times_survey_report_user_answer_times_component__WEBPACK_IMPORTED_MODULE_5__["SurveyReportUserAnswerTimesComponent"])
    ], SurveyUserReportComponent.prototype, "surveyReportUserAnswerTimesComponent", void 0);
    SurveyUserReportComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"],
            ...
            _survey_report_service__WEBPACK_IMPORTED_MODULE_2__["SurveyReportService"]])
...
/* harmony import */ var _question_group_question_group_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./question-group/question-group.component */ "./src/app/modules/surveys/question-group/question-group.component.ts");
/* harmony import */ var _question_group_service_question_group_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./question-group/service/question-group.service */ "./src/app/modules/surveys/question-group/service/question-group.service.ts");
/* harmony import */ var _survey_group_survey_group_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./survey-group/survey-group.component */ "./src/app/modules/surveys/survey-group/survey-group.component.ts");
...
/* harmony import */ var _question_question_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./question/question.component */ "./src/app/modules/surveys/question/question.component.ts");
/* harmony import */ var _question_service_question_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./question/service/question.service */ "./src/app/modules/surveys/question/service/question.service.ts");
/* harmony import */ var _do_exam_do_exam_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./do-exam/do-exam.component */ "./src/app/modules/surveys/do-exam/do-exam.component.ts");
/* harmony import */ var _question_question_approve_question_approve_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./question/question-approve/question-approve.component */ "./src/app/modules/surveys/question/question-approve/question-approve.component.ts");
/* harmony import */ var _question_service_question_approve_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./question/service/question-approve.service */ "./src/app/modules/surveys/question/service/question-approve.service.ts");
/* harmony import */ var _survey_survey_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./survey/survey.service */ "./src/app/modules/surveys/survey/survey.service.ts");
/* harmony import */ var _survey_survey_list_survey_list_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./survey/survey-list/survey-list.component */ "./src/app/modules/surveys/survey/survey-list/survey-list.component.ts");
/* harmony import */ var _question_question_detail_page_question_detail_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./question/question-detail/page-question-detail.component */ "./src/app/modules/surveys/question/question-detail/page-question-detail.component.ts");
...
var surveyRoutes = [
    {
        path: '',
        resolve: {
            data: _survey_survey_service__WEBPACK_IMPORTED_MODULE_11__["SurveyService"],
        },
        component: _survey_survey_list_survey_list_component__WEBPACK_IMPORTED_MODULE_12__["SurveyListComponent"]
    },
    {
        path: 'question-group',
        component: _question_group_question_group_component__WEBPACK_IMPORTED_MODULE_2__["QuestionGroupComponent"],
        resolve: {
            data: _question_group_service_question_group_service__WEBPACK_IMPORTED_MODULE_3__["QuestionGroupService"]
        }
    }, {
        path: 'survey-group',
        component: _survey_group_survey_group_component__WEBPACK_IMPORTED_MODULE_4__["SurveyGroupComponent"],
        resolve: {
            data: _survey_group_services_survey_group_service__WEBPACK_IMPORTED_MODULE_5__["SurveyGroupService"]
        }
    },
    {
        path: 'question',
        component: _question_question_component__WEBPACK_IMPORTED_MODULE_6__["QuestionComponent"],
        resolve: {
            searchResult: _question_service_question_service__WEBPACK_IMPORTED_MODULE_7__["QuestionService"]
        }
    },
    {
        path: 'question-approve',
        component: _question_question_approve_question_approve_component__WEBPACK_IMPORTED_MODULE_9__["QuestionApproveComponent"],
        resolve: {
            searchResult: _question_service_question_approve_service__WEBPACK_IMPORTED_MODULE_10__["QuestionApproveService"]
        }
    },
    {
        path: 'question/:versionId',
        component: _question_question_detail_page_question_detail_component__WEBPACK_IMPORTED_MODULE_13__["PageQuestionDetailComponent"],
        resolve: { versionId: _question_question_detail_question_detail_resolve__WEBPACK_IMPORTED_MODULE_14__["QuestionDetailResolve"] }
    },
    {
    ...
    {
        path: 'start/:id',
        component: _do_exam_do_exam_component__WEBPACK_IMPORTED_MODULE_8__["DoExamComponent"],
        resolve: {
            data: _do_exam_do_exam_resolve__WEBPACK_IMPORTED_MODULE_15__["DoExamResolve"]
        }
    },
    {
        path: 'finish-exam',
...
var SurveyRoutingModule = /** @class */ (function () {
    ...
    SurveyRoutingModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(surveyRoutes)],
            exports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]],
            providers: [_question_group_service_question_group_service__WEBPACK_IMPORTED_MODULE_3__["QuestionGroupService"], _survey_group_services_survey_group_service__WEBPACK_IMPORTED_MODULE_5__["SurveyGroupService"], _survey_survey_service__WEBPACK_IMPORTED_MODULE_11__["SurveyService"],
...
/* harmony import */ var _shareds_components_nh_tree_nh_tree_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../shareds/components/nh-tree/nh-tree.module */ "./src/app/shareds/components/nh-tree/nh-tree.module.ts");
...
/* harmony import */ var _validators_number_validator__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../validators/number.validator */ "./src/app/validators/number.validator.ts");
/* harmony import */ var _question_group_question_group_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./question-group/question-group.component */ "./src/app/modules/surveys/question-group/question-group.component.ts");
...
/* harmony import */ var _question_group_question_group_form_question_group_form_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./question-group/question-group-form/question-group-form.component */ "./src/app/modules/surveys/question-group/question-group-form/question-group-form.component.ts");
...
/* harmony import */ var _survey_routing_module__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./survey-routing.module */ "./src/app/modules/surveys/survey-routing.module.ts");
/* harmony import */ var _survey_group_survey_group_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./survey-group/survey-group.component */ "./src/app/modules/surveys/survey-group/survey-group.component.ts");
/* harmony import */ var _survey_group_survey_group_form_survey_group_form_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./survey-group/survey-group-form/survey-group-form.component */ "./src/app/modules/surveys/survey-group/survey-group-form/survey-group-form.component.ts");
/* harmony import */ var _question_question_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./question/question.component */ "./src/app/modules/surveys/question/question.component.ts");
/* harmony import */ var _question_question_form_question_form_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./question/question-form/question-form.component */ "./src/app/modules/surveys/question/question-form/question-form.component.ts");
/* harmony import */ var _question_service_question_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./question/service/question.service */ "./src/app/modules/surveys/question/service/question.service.ts");
...
/* harmony import */ var _survey_survey_form_survey_form_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./survey/survey-form/survey-form.component */ "./src/app/modules/surveys/survey/survey-form/survey-form.component.ts");
/* harmony import */ var _survey_survey_list_survey_list_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./survey/survey-list/survey-list.component */ "./src/app/modules/surveys/survey/survey-list/survey-list.component.ts");
/* harmony import */ var _shareds_components_nh_datetime_picker_nh_date_module__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../../shareds/components/nh-datetime-picker/nh-date.module */ "./src/app/shareds/components/nh-datetime-picker/nh-date.module.ts");
/* harmony import */ var _question_question_select_question_select_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./question/question-select/question-select.component */ "./src/app/modules/surveys/question/question-select/question-select.component.ts");
/* harmony import */ var _question_answer_answer_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./question/answer/answer.component */ "./src/app/modules/surveys/question/answer/answer.component.ts");
/* harmony import */ var _question_question_detail_question_detail_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./question/question-detail/question-detail.component */ "./src/app/modules/surveys/question/question-detail/question-detail.component.ts");
/* harmony import */ var _do_exam_do_exam_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./do-exam/do-exam.component */ "./src/app/modules/surveys/do-exam/do-exam.component.ts");
/* harmony import */ var _question_question_approve_question_approve_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./question/question-approve/question-approve.component */ "./src/app/modules/surveys/question/question-approve/question-approve.component.ts");
/* harmony import */ var _question_service_question_approve_service__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./question/service/question-approve.service */ "./src/app/modules/surveys/question/service/question-approve.service.ts");
/* harmony import */ var _question_question_detail_page_question_detail_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./question/question-detail/page-question-detail.component */ "./src/app/modules/surveys/question/question-detail/page-question-detail.component.ts");
/* harmony import */ var _do_exam_service_do_exam_service__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./do-exam/service/do-exam.service */ "./src/app/modules/surveys/do-exam/service/do-exam.service.ts");
/* harmony import */ var _shareds_components_ghm_select_picker_ghm_select_picker_module__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ../../shareds/components/ghm-select-picker/ghm-select-picker.module */ "./src/app/shareds/components/ghm-select-picker/ghm-select-picker.module.ts");
/* harmony import */ var _shareds_components_nh_user_picker_nh_user_picker_module__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ../../shareds/components/nh-user-picker/nh-user-picker.module */ "./src/app/shareds/components/nh-user-picker/nh-user-picker.module.ts");
/* harmony import */ var _question_question_approve_question_explain_decline_reason_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./question/question-approve/question-explain-decline-reason.component */ "./src/app/modules/surveys/question/question-approve/question-explain-decline-reason.component.ts");
/* harmony import */ var _do_exam_exam_overview_exam_overview_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./do-exam/exam-overview/exam-overview.component */ "./src/app/modules/surveys/do-exam/exam-overview/exam-overview.component.ts");
/* harmony import */ var _shareds_pipe_datetime_format_datetime_format_module__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ../../shareds/pipe/datetime-format/datetime-format.module */ "./src/app/shareds/pipe/datetime-format/datetime-format.module.ts");
/* harmony import */ var _do_exam_finish_exam_finish_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./do-exam/finish-exam/finish.component */ "./src/app/modules/surveys/do-exam/finish-exam/finish.component.ts");
/* harmony import */ var _survey_report_survey_report_component__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./survey-report/survey-report.component */ "./src/app/modules/surveys/survey-report/survey-report.component.ts");
/* harmony import */ var _survey_report_survey_user_report_survey_user_report_component__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./survey-report/survey-user-report/survey-user-report.component */ "./src/app/modules/surveys/survey-report/survey-user-report/survey-user-report.component.ts");
/* harmony import */ var _survey_report_survey_report_by_user_detail_survey_report_by_user_detail_component__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ./survey-report/survey-report-by-user-detail/survey-report-by-user-detail.component */ "./src/app/modules/surveys/survey-report/survey-report-by-user-detail/survey-report-by-user-detail.component.ts");
/* harmony import */ var angular_highcharts__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! angular-highcharts */ "./node_modules/angular-highcharts/angular-highcharts.es5.js");
...
var SurveyModule = /** @class */ (function () {
    ...
    SurveyModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _survey_routing_module__WEBPACK_IMPORTED_MODULE_14__["SurveyRoutingModule"], _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatButtonModule"], _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatCheckboxModule"], _shareds_components_nh_datetime_picker_nh_date_module__WEBPACK_IMPORTED_MODULE_23__["NhDateModule"], _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatRadioModule"],
                _shareds_components_nh_tree_nh_tree_module__WEBPACK_IMPORTED_MODULE_5__["NHTreeModule"], _shareds_components_nh_select_nh_select_module__WEBPACK_IMPORTED_MODULE_4__["NhSelectModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _core_core_module__WEBPACK_IMPORTED_MODULE_13__["CoreModule"], _shareds_components_nh_modal_nh_modal_module__WEBPACK_IMPORTED_MODULE_6__["NhModalModule"], _shareds_components_ghm_user_suggestion_ghm_user_suggestion_module__WEBPACK_IMPORTED_MODULE_20__["GhmUserSuggestionModule"],
                _shareds_components_ghm_select_picker_ghm_select_picker_module__WEBPACK_IMPORTED_MODULE_32__["GhmSelectPickerModule"], _shareds_components_nh_user_picker_nh_user_picker_module__WEBPACK_IMPORTED_MODULE_33__["NhUserPickerModule"], _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatButtonModule"], _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatIconModule"], _shareds_components_ghm_paging_ghm_paging_module__WEBPACK_IMPORTED_MODULE_12__["GhmPagingModule"], angular_highcharts__WEBPACK_IMPORTED_MODULE_41__["ChartModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatButtonModule"], _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatIconModule"], _shareds_components_ghm_paging_ghm_paging_module__WEBPACK_IMPORTED_MODULE_12__["GhmPagingModule"], _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatTooltipModule"], _shareds_pipe_datetime_format_datetime_format_module__WEBPACK_IMPORTED_MODULE_36__["DatetimeFormatModule"],
            ...
            declarations: [_question_group_question_group_component__WEBPACK_IMPORTED_MODULE_9__["QuestionGroupComponent"], _question_group_question_group_form_question_group_form_component__WEBPACK_IMPORTED_MODULE_11__["QuestionGroupFormComponent"], _survey_group_survey_group_component__WEBPACK_IMPORTED_MODULE_15__["SurveyGroupComponent"], _question_question_select_question_select_component__WEBPACK_IMPORTED_MODULE_24__["QuestionSelectComponent"],
                _survey_group_survey_group_form_survey_group_form_component__WEBPACK_IMPORTED_MODULE_16__["SurveyGroupFormComponent"], _question_question_component__WEBPACK_IMPORTED_MODULE_17__["QuestionComponent"], _question_question_form_question_form_component__WEBPACK_IMPORTED_MODULE_18__["QuestionFormComponent"], _survey_survey_list_survey_list_component__WEBPACK_IMPORTED_MODULE_22__["SurveyListComponent"], _survey_survey_form_survey_form_component__WEBPACK_IMPORTED_MODULE_21__["SurveyFormComponent"],
                _question_question_detail_question_detail_component__WEBPACK_IMPORTED_MODULE_26__["QuestionDetailComponent"], _question_answer_answer_component__WEBPACK_IMPORTED_MODULE_25__["AnswerComponent"], _question_question_approve_question_approve_component__WEBPACK_IMPORTED_MODULE_28__["QuestionApproveComponent"], _do_exam_do_exam_component__WEBPACK_IMPORTED_MODULE_27__["DoExamComponent"], _question_question_detail_page_question_detail_component__WEBPACK_IMPORTED_MODULE_30__["PageQuestionDetailComponent"],
                _question_question_approve_question_explain_decline_reason_component__WEBPACK_IMPORTED_MODULE_34__["QuestionExplainDeclineReasonComponent"], _do_exam_exam_overview_exam_overview_component__WEBPACK_IMPORTED_MODULE_35__["ExamOverviewComponent"], _do_exam_finish_exam_finish_component__WEBPACK_IMPORTED_MODULE_37__["FinishComponent"], _survey_report_survey_report_component__WEBPACK_IMPORTED_MODULE_38__["SurveyReportComponent"], _survey_report_survey_user_report_survey_user_report_component__WEBPACK_IMPORTED_MODULE_39__["SurveyUserReportComponent"],
                _survey_report_survey_report_by_user_detail_survey_report_by_user_detail_component__WEBPACK_IMPORTED_MODULE_40__["SurveyReportByUserDetailComponent"], _survey_report_survey_report_user_answer_times_survey_report_user_answer_times_component__WEBPACK_IMPORTED_MODULE_42__["SurveyReportUserAnswerTimesComponent"],
                _question_question_approve_question_explain_decline_reason_component__WEBPACK_IMPORTED_MODULE_34__["QuestionExplainDeclineReasonComponent"], _do_exam_exam_overview_exam_overview_component__WEBPACK_IMPORTED_MODULE_35__["ExamOverviewComponent"], _do_exam_finish_exam_finish_component__WEBPACK_IMPORTED_MODULE_37__["FinishComponent"], _do_exam_exam_detail_exam_deatil_component__WEBPACK_IMPORTED_MODULE_43__["ExamDetailComponent"], _my_survey_my_survey_component__WEBPACK_IMPORTED_MODULE_44__["MySurveyComponent"],
                _question_question_approve_question_explain_decline_reason_component__WEBPACK_IMPORTED_MODULE_34__["QuestionExplainDeclineReasonComponent"], _do_exam_exam_overview_exam_overview_component__WEBPACK_IMPORTED_MODULE_35__["ExamOverviewComponent"], _do_exam_finish_exam_finish_component__WEBPACK_IMPORTED_MODULE_37__["FinishComponent"], _do_exam_exam_detail_exam_deatil_component__WEBPACK_IMPORTED_MODULE_43__["ExamDetailComponent"],
                _survey_report_survey_report_by_user_detail_survey_report_by_user_detail_component__WEBPACK_IMPORTED_MODULE_40__["SurveyReportByUserDetailComponent"], _do_exam_exam_detail_exam_deatil_component__WEBPACK_IMPORTED_MODULE_43__["ExamDetailComponent"]],
            entryComponents: [],
            providers: [_validators_datetime_validator__WEBPACK_IMPORTED_MODULE_7__["DateTimeValidator"], _validators_number_validator__WEBPACK_IMPORTED_MODULE_8__["NumberValidator"], _question_service_question_service__WEBPACK_IMPORTED_MODULE_19__["QuestionService"],
                _question_service_question_approve_service__WEBPACK_IMPORTED_MODULE_29__["QuestionApproveService"], _do_exam_service_do_exam_service__WEBPACK_IMPORTED_MODULE_31__["DoExamService"]]
        })
    ], SurveyModule);
    return SurveyModule;
}());
...
/* harmony import */ var _base_form_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../base-form.component */ "./src/app/base-form.component.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _survey_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../survey.model */ "./src/app/modules/surveys/survey/survey.model.ts");
/* harmony import */ var _survey_translation_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../survey-translation.model */ "./src/app/modules/surveys/survey/survey-translation.model.ts");
/* harmony import */ var _survey_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../survey.service */ "./src/app/modules/surveys/survey/survey.service.ts");
...
/* harmony import */ var _question_question_select_question_select_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../question/question-select/question-select.component */ "./src/app/modules/surveys/question/question-select/question-select.component.ts");
/* harmony import */ var _shareds_components_nh_user_picker_nh_user_picker_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../../shareds/components/nh-user-picker/nh-user-picker.component */ "./src/app/shareds/components/nh-user-picker/nh-user-picker.component.ts");
...
var SurveyFormComponent = /** @class */ (function (_super) {
    __extends(SurveyFormComponent, _super);
    function SurveyFormComponent(fb, surveyService) {
        var _this = _super.call(this) || this;
        _this.fb = fb;
        _this.surveyService = surveyService;
        _this.surveyGroupTree = [];
        _this.survey = new _survey_model__WEBPACK_IMPORTED_MODULE_3__["Survey"]();
        _this.surevyTranslation = new _survey_translation_model__WEBPACK_IMPORTED_MODULE_4__["SurveyTranslation"]();
        ...
        this.surveyService.detail(id)
            ...
            if (surveyDetail) {
                ...
                if (surveyDetail.surveyTranslations && surveyDetail.surveyTranslations.length > 0) {
                    _this.modelTranslations.controls.forEach(function (model) {
                        var detail = lodash__WEBPACK_IMPORTED_MODULE_9__["find"](surveyDetail.surveyTranslations, function (translation) {
    ...
    SurveyFormComponent.prototype.chooseQuestion = function () {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('surveyFormModal'),
        __metadata("design:type", _shareds_components_nh_modal_nh_modal_component__WEBPACK_IMPORTED_MODULE_6__["NhModalComponent"])
    ], SurveyFormComponent.prototype, "surveyFormModal", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_question_question_select_question_select_component__WEBPACK_IMPORTED_MODULE_7__["QuestionSelectComponent"]),
        __metadata("design:type", _question_question_select_question_select_component__WEBPACK_IMPORTED_MODULE_7__["QuestionSelectComponent"])
    ], SurveyFormComponent.prototype, "questionSelectComponent", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_shareds_components_nh_user_picker_nh_user_picker_component__WEBPACK_IMPORTED_MODULE_8__["NhUserPickerComponent"]),
        __metadata("design:type", _shareds_components_nh_user_picker_nh_user_picker_component__WEBPACK_IMPORTED_MODULE_8__["NhUserPickerComponent"])
    ], SurveyFormComponent.prototype, "userPickerComponent", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], SurveyFormComponent.prototype, "surveyGroupTree", void 0);
    SurveyFormComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"],
            _survey_service__WEBPACK_IMPORTED_MODULE_5__["SurveyService"]])
    ], SurveyFormComponent);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _base_list_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../base-list.component */ "./src/app/base-list.component.ts");
/* harmony import */ var _survey_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../survey.service */ "./src/app/modules/surveys/survey/survey.service.ts");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _configs_page_id_config__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../configs/page-id.config */ "./src/app/configs/page-id.config.ts");
/* harmony import */ var _survey_form_survey_form_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../survey-form/survey-form.component */ "./src/app/modules/surveys/survey/survey-form/survey-form.component.ts");
...
var SurveyListComponent = /** @class */ (function (_super) {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_survey_form_survey_form_component__WEBPACK_IMPORTED_MODULE_6__["SurveyFormComponent"]),
        __metadata("design:type", _survey_form_survey_form_component__WEBPACK_IMPORTED_MODULE_6__["SurveyFormComponent"])
    ...
    SurveyListComponent = __decorate([
        ...
        __metadata("design:paramtypes", [Object, _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"],
            _survey_service__WEBPACK_IMPORTED_MODULE_2__["SurveyService"],
...
var SurveyService = /** @class */ (function () {
    ...
    SurveyService.prototype.detail = function (id) {
        ...
        return this.http
            ...
            surveyDetail.questions = surveyDetailResult.questions.map(function (question) {
                return {
            ...
            surveyDetail.questionGroups = surveyDetailResult.questionGroups.map(function (questionGroup) {
                return {
