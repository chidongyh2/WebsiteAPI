...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.search = function (keyword, positionId, status, officeIdPath, gender, monthBirthDay, yearBirthday, academicRank, page, pageSize) {
        ...
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]()
            ...
            .set('gender', gender ? gender.toString() : '')
    ...
    UserService.prototype.searchEthnic = function () {
    ...
    UserService.prototype.insertUserContact = function (userContact) {
        return this.http.post(this.url + "insert-user-contact", userContact);
    };
    UserService.prototype.updateUserContact = function (userContact) {
