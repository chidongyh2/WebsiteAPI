...
namespace GHM.Website.JadesSpa.Controllers
{
    public class AlbumController : BaseController
    {
        ...
        public AlbumController(IConfiguration configuration, IMemoryCache cache, IHttpClientService httpClientService) : base(configuration, cache , httpClientService)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var listAlbum = await _httpClienService.GetAsync<SearchResult<AlbumViewModel>>
        ...
        public async Task<JsonResult> GetVideoByAlbum(string seoLink, int page, int pageSize)
        {
            var requestUrl = _configuration.GetApiUrl();
            var apiService = _configuration.GetApiServiceInfo();
            var listVideo = await _httpClienService.GetAsync<SearchResult<AlbumItemViewModel>>
