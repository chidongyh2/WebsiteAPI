function AboutViewModel() {
    ...
    self.currentPageComment = ko.observable(0);
    ...
    self.setCurrentPage = function (value) {
        if (value == 0) {
            if (ko.utils.unwrapObservable(self.currentPageComment()) == 0) {
    ...
    self.pushListComment = function () {
        ...
        if (ko.utils.unwrapObservable(self.currentPageComment()) == ko.utils.unwrapObservable(self.totalPage())) {
            ...
            for (i = ko.utils.unwrapObservable(self.currentPageComment); i < ko.utils.unwrapObservable(self.currentPageComment()) + 3; i++) {
                self.listCommentCustomer.push(self.listResponseCustomer()[i]);
            }
        }
    }
    $(document).ready(function () {
        ...
        self.totalPage(((self.listResponseCustomer().length / 3) % 2 == 0) ? (self.listResponseCustomer().length/3) : (self.listResponseCustomer().length/3 + 1));
        self.pushListComment();
